...
impl Instruction {
    ...
    pub fn visit<T>(&self, visitor: &mut T) -> T::Outcome
    where
        T: VisitInstruction,
    {
        match self {
            ...
            Instruction::BrTable { len_targets } => todo!(),
            Instruction::BrTableTarget(_) => todo!(),
            ...
            Instruction::FuncBodyStart { .. } => todo!(),
            Instruction::FuncBodyEnd => todo!(),
        }
    }
}
