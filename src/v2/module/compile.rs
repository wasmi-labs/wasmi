...
impl ControlFrame {
    ...
    fn br_destination(&self) -> LabelIdx {
        match self {
...
impl FuncBodyTranslator {
    ...
    fn translate_instruction(&mut self, instruction: &Instruction) -> Result<(), TranslationError> {
        ...
        match instruction {
            ...
            Inst::Nop => todo!(),
            Inst::Block(block_type) => todo!(),
            Inst::Loop(block_type) => todo!(),
            Inst::If(block_type) => todo!(),
            Inst::Else => todo!(),
            Inst::End => todo!(),
            Inst::Br(target) => todo!(),
            Inst::BrIf(target) => todo!(),
            Inst::BrTable(br_table) => todo!(),
            Inst::Return => todo!(),
            Inst::Call(func_idx) => todo!(),
            Inst::CallIndirect(signature_idx, table_ref) => todo!(),
            Inst::Drop => todo!(),
            Inst::Select => todo!(),
            Inst::GetLocal(local_idx) => todo!(),
            Inst::SetLocal(local_idx) => todo!(),
            Inst::TeeLocal(local_idx) => todo!(),
            Inst::GetGlobal(global_idx) => todo!(),
            Inst::SetGlobal(global_idx) => todo!(),
