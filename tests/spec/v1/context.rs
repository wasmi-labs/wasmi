...
impl<'a> TestContext<'a> {
    ...
    pub fn new(descriptor: &'a TestDescriptor) -> Self {
        ...
        let global_f32 = Global::new(&mut store, RuntimeValue::F32(666.0.into()), Mutability::Const);
        let global_f64 = Global::new(&mut store, RuntimeValue::F64(666.0.into()), Mutability::Const);
