...
/// An untyped immediate (constant) value.
#[derive(Debug, Copy, Clone)]
...
/// value of type `i32`.
#[derive(Debug, Copy, Clone)]
pub struct RegisterOrImmediate(i32);

/// An index into the register slice of an [`Instruction`].
///
/// # Note
///
/// This is used to efficiently represent a varaible amount
/// of registers as used by return or call instructions.
#[derive(Debug, Copy, Clone)]
pub struct RegisterSlice(u16);
...
fn size_of_instruction() {
    ...
    assert_eq!(size_of::<RegisterOrImmediate>(), 4);
...
pub enum Instruction {
    ...
    Call {
        ...
        results: ContiguousRegisterSlice,
        /// The parameters of the function call.
        params: RegisterSlice,
    },
    ...
    Select {
        ...
        if_true: RegisterOrImmediate,
        /// Stored into `result` if `condition` evaluates to `0` (false).
        if_false: RegisterOrImmediate,
    },
