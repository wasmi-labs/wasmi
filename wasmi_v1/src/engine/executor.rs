...
pub fn execute_frame<'engine>(
    ...
    loop {
        match *executor.instr(&insts) {
            ...
            Instr::Br(target) => executor.visit_br(target),
            Instr::BrIfEqz(target) => executor.visit_br_if_eqz(target),
            Instr::BrIfNez(target) => executor.visit_br_if_nez(target),
            Instr::ReturnIfNez(drop_keep) => {
                if let MaybeReturn::Return = executor.visit_return_if_nez(drop_keep) {
                    return Ok(CallOutcome::Return)
                }
            }
            Instr::BrTable { len_targets } => executor.visit_br_table(len_targets),
            Instr::Unreachable => executor.visit_unreachable()?,
            Instr::Return(drop_keep) => return executor.visit_ret(drop_keep),
            Instr::Call(func) => return executor.visit_call(func),
            Instr::CallIndirect(signature) => {
                return executor.visit_call_indirect(signature)
            }
            Instr::Drop => executor.visit_drop(),
            Instr::Select => executor.visit_select(),
            Instr::GlobalGet(global_idx) => executor.visit_get_global(global_idx),
            Instr::GlobalSet(global_idx) => executor.visit_set_global(global_idx),
            Instr::I32Load(offset) => executor.visit_i32_load(offset)?,
            Instr::I64Load(offset) => executor.visit_i64_load(offset)?,
            Instr::F32Load(offset) => executor.visit_f32_load(offset)?,
            Instr::F64Load(offset) => executor.visit_f64_load(offset)?,
            Instr::I32Load8S(offset) => executor.visit_i32_load_i8(offset)?,
            Instr::I32Load8U(offset) => executor.visit_i32_load_u8(offset)?,
            Instr::I32Load16S(offset) => executor.visit_i32_load_i16(offset)?,
            Instr::I32Load16U(offset) => executor.visit_i32_load_u16(offset)?,
            Instr::I64Load8S(offset) => executor.visit_i64_load_i8(offset)?,
            Instr::I64Load8U(offset) => executor.visit_i64_load_u8(offset)?,
            Instr::I64Load16S(offset) => executor.visit_i64_load_i16(offset)?,
            Instr::I64Load16U(offset) => executor.visit_i64_load_u16(offset)?,
            Instr::I64Load32S(offset) => executor.visit_i64_load_i32(offset)?,
            Instr::I64Load32U(offset) => executor.visit_i64_load_u32(offset)?,
            Instr::I32Store(offset) => executor.visit_i32_store(offset)?,
            Instr::I64Store(offset) => executor.visit_i64_store(offset)?,
            Instr::F32Store(offset) => executor.visit_f32_store(offset)?,
            Instr::F64Store(offset) => executor.visit_f64_store(offset)?,
            Instr::I32Store8(offset) => executor.visit_i32_store_8(offset)?,
            Instr::I32Store16(offset) => executor.visit_i32_store_16(offset)?,
            Instr::I64Store8(offset) => executor.visit_i64_store_8(offset)?,
            Instr::I64Store16(offset) => executor.visit_i64_store_16(offset)?,
            Instr::I64Store32(offset) => executor.visit_i64_store_32(offset)?,
            Instr::MemorySize => executor.visit_current_memory(),
            Instr::MemoryGrow => executor.visit_grow_memory(),
            Instr::Const(bytes) => executor.visit_const(bytes),
            Instr::I32Eqz => executor.visit_i32_eqz(),
            Instr::I32Eq => executor.visit_i32_eq(),
            Instr::I32Ne => executor.visit_i32_ne(),
            Instr::I32LtS => executor.visit_i32_lt_s(),
            Instr::I32LtU => executor.visit_i32_lt_u(),
            Instr::I32GtS => executor.visit_i32_gt_s(),
            Instr::I32GtU => executor.visit_i32_gt_u(),
            Instr::I32LeS => executor.visit_i32_le_s(),
            Instr::I32LeU => executor.visit_i32_le_u(),
            Instr::I32GeS => executor.visit_i32_ge_s(),
            Instr::I32GeU => executor.visit_i32_ge_u(),
            Instr::I64Eqz => executor.visit_i64_eqz(),
            Instr::I64Eq => executor.visit_i64_eq(),
            Instr::I64Ne => executor.visit_i64_ne(),
            Instr::I64LtS => executor.visit_i64_lt_s(),
            Instr::I64LtU => executor.visit_i64_lt_u(),
            Instr::I64GtS => executor.visit_i64_gt_s(),
            Instr::I64GtU => executor.visit_i64_gt_u(),
            Instr::I64LeS => executor.visit_i64_le_s(),
            Instr::I64LeU => executor.visit_i64_le_u(),
            Instr::I64GeS => executor.visit_i64_ge_s(),
            Instr::I64GeU => executor.visit_i64_ge_u(),
            Instr::F32Eq => executor.visit_f32_eq(),
            Instr::F32Ne => executor.visit_f32_ne(),
            Instr::F32Lt => executor.visit_f32_lt(),
            Instr::F32Gt => executor.visit_f32_gt(),
            Instr::F32Le => executor.visit_f32_le(),
            Instr::F32Ge => executor.visit_f32_ge(),
            Instr::F64Eq => executor.visit_f64_eq(),
            Instr::F64Ne => executor.visit_f64_ne(),
            Instr::F64Lt => executor.visit_f64_lt(),
            Instr::F64Gt => executor.visit_f64_gt(),
            Instr::F64Le => executor.visit_f64_le(),
            Instr::F64Ge => executor.visit_f64_ge(),
            Instr::I32Clz => executor.visit_i32_clz(),
            Instr::I32Ctz => executor.visit_i32_ctz(),
            Instr::I32Popcnt => executor.visit_i32_popcnt(),
            Instr::I32Add => executor.visit_i32_add(),
            Instr::I32Sub => executor.visit_i32_sub(),
            Instr::I32Mul => executor.visit_i32_mul(),
            Instr::I32DivS => executor.visit_i32_div_s()?,
            Instr::I32DivU => executor.visit_i32_div_u()?,
            Instr::I32RemS => executor.visit_i32_rem_s()?,
            Instr::I32RemU => executor.visit_i32_rem_u()?,
            Instr::I32And => executor.visit_i32_and(),
            Instr::I32Or => executor.visit_i32_or(),
            Instr::I32Xor => executor.visit_i32_xor(),
            Instr::I32Shl => executor.visit_i32_shl(),
            Instr::I32ShrS => executor.visit_i32_shr_s(),
            Instr::I32ShrU => executor.visit_i32_shr_u(),
            Instr::I32Rotl => executor.visit_i32_rotl(),
            Instr::I32Rotr => executor.visit_i32_rotr(),
            Instr::I64Clz => executor.visit_i64_clz(),
            Instr::I64Ctz => executor.visit_i64_ctz(),
            Instr::I64Popcnt => executor.visit_i64_popcnt(),
            Instr::I64Add => executor.visit_i64_add(),
            Instr::I64Sub => executor.visit_i64_sub(),
            Instr::I64Mul => executor.visit_i64_mul(),
            Instr::I64DivS => executor.visit_i64_div_s()?,
            Instr::I64DivU => executor.visit_i64_div_u()?,
            Instr::I64RemS => executor.visit_i64_rem_s()?,
            Instr::I64RemU => executor.visit_i64_rem_u()?,
            Instr::I64And => executor.visit_i64_and(),
            Instr::I64Or => executor.visit_i64_or(),
            Instr::I64Xor => executor.visit_i64_xor(),
            Instr::I64Shl => executor.visit_i64_shl(),
            Instr::I64ShrS => executor.visit_i64_shr_s(),
            Instr::I64ShrU => executor.visit_i64_shr_u(),
            Instr::I64Rotl => executor.visit_i64_rotl(),
            Instr::I64Rotr => executor.visit_i64_rotr(),
            Instr::F32Abs => executor.visit_f32_abs(),
            Instr::F32Neg => executor.visit_f32_neg(),
            Instr::F32Ceil => executor.visit_f32_ceil(),
            Instr::F32Floor => executor.visit_f32_floor(),
            Instr::F32Trunc => executor.visit_f32_trunc(),
            Instr::F32Nearest => executor.visit_f32_nearest(),
            Instr::F32Sqrt => executor.visit_f32_sqrt(),
            Instr::F32Add => executor.visit_f32_add(),
            Instr::F32Sub => executor.visit_f32_sub(),
            Instr::F32Mul => executor.visit_f32_mul(),
            Instr::F32Div => executor.visit_f32_div()?,
            Instr::F32Min => executor.visit_f32_min(),
            Instr::F32Max => executor.visit_f32_max(),
            Instr::F32Copysign => executor.visit_f32_copysign(),
            Instr::F64Abs => executor.visit_f64_abs(),
            Instr::F64Neg => executor.visit_f64_neg(),
            Instr::F64Ceil => executor.visit_f64_ceil(),
            Instr::F64Floor => executor.visit_f64_floor(),
            Instr::F64Trunc => executor.visit_f64_trunc(),
            Instr::F64Nearest => executor.visit_f64_nearest(),
            Instr::F64Sqrt => executor.visit_f64_sqrt(),
            Instr::F64Add => executor.visit_f64_add(),
            Instr::F64Sub => executor.visit_f64_sub(),
            Instr::F64Mul => executor.visit_f64_mul(),
            Instr::F64Div => executor.visit_f64_div()?,
            Instr::F64Min => executor.visit_f64_min(),
            Instr::F64Max => executor.visit_f64_max(),
            Instr::F64Copysign => executor.visit_f64_copysign(),
            Instr::I32WrapI64 => executor.visit_i32_wrap_i64(),
            Instr::I32TruncSF32 => executor.visit_i32_trunc_f32()?,
            Instr::I32TruncUF32 => executor.visit_u32_trunc_f32()?,
            Instr::I32TruncSF64 => executor.visit_i32_trunc_f64()?,
            Instr::I32TruncUF64 => executor.visit_u32_trunc_f64()?,
            Instr::I64ExtendSI32 => executor.visit_i64_extend_i32(),
            Instr::I64ExtendUI32 => executor.visit_i64_extend_u32(),
            Instr::I64TruncSF32 => executor.visit_i64_trunc_f32()?,
            Instr::I64TruncUF32 => executor.visit_u64_trunc_f32()?,
            Instr::I64TruncSF64 => executor.visit_i64_trunc_f64()?,
            Instr::I64TruncUF64 => executor.visit_u64_trunc_f64()?,
            Instr::F32ConvertSI32 => executor.visit_f32_convert_i32(),
            Instr::F32ConvertUI32 => executor.visit_f32_convert_u32(),
            Instr::F32ConvertSI64 => executor.visit_f32_convert_i64(),
            Instr::F32ConvertUI64 => executor.visit_f32_convert_u64(),
            Instr::F32DemoteF64 => executor.visit_f32_demote_f64(),
            Instr::F64ConvertSI32 => executor.visit_f64_convert_i32(),
            Instr::F64ConvertUI32 => executor.visit_f64_convert_u32(),
            Instr::F64ConvertSI64 => executor.visit_f64_convert_i64(),
            Instr::F64ConvertUI64 => executor.visit_f64_convert_u64(),
            Instr::F64PromoteF32 => executor.visit_f64_promote_f32(),
            Instr::I32ReinterpretF32 => executor.visit_i32_reinterpret_f32(),
            Instr::I64ReinterpretF64 => executor.visit_i64_reinterpret_f64(),
            Instr::F32ReinterpretI32 => executor.visit_f32_reinterpret_i32(),
            Instr::F64ReinterpretI64 => executor.visit_f64_reinterpret_i64(),
            Instr::I32TruncSatF32S => executor.visit_i32_trunc_sat_f32(),
            Instr::I32TruncSatF32U => executor.visit_u32_trunc_sat_f32(),
            Instr::I32TruncSatF64S => executor.visit_i32_trunc_sat_f64(),
            Instr::I32TruncSatF64U => executor.visit_u32_trunc_sat_f64(),
            Instr::I64TruncSatF32S => executor.visit_i64_trunc_sat_f32(),
            Instr::I64TruncSatF32U => executor.visit_u64_trunc_sat_f32(),
            Instr::I64TruncSatF64S => executor.visit_i64_trunc_sat_f64(),
            Instr::I64TruncSatF64U => executor.visit_u64_trunc_sat_f64(),
            Instr::I32Extend8S => executor.visit_i32_sign_extend8(),
            Instr::I32Extend16S => executor.visit_i32_sign_extend16(),
            Instr::I64Extend8S => executor.visit_i64_sign_extend8(),
            Instr::I64Extend16S => executor.visit_i64_sign_extend16(),
    ...
    Ctx: AsContextMut,
{
    ...
    #[inline(always)]
    fn instr(&self, insts: &Instructions<'engine>) -> &'engine Instruction {
        // # Safety
        //
        // Properly constructed `wasmi` bytecode can never produce invalid `pc`.
        unsafe { insts.get_release_unchecked(self.pc) }
    }
