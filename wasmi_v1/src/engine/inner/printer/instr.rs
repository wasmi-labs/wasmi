...
impl<'ctx, 'engine, T> DisplayExecInstruction<'ctx, 'engine, T> {
        ...
        R: Into<ExecProvider>,
    {
        writeln!(
            ...
            DisplayExecProvider::new(self.res, rhs.into()),
        )
    }
...
impl<T> Display for DisplayExecInstruction<'_, '_, T> {
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self.instr {
            ...
            Instr::I32EqImm { result, lhs, rhs } => self.write_binary(f, "i32.eq", result, lhs, rhs),
            Instr::I32Ne { result, lhs, rhs } => self.write_binary(f, "i32.ne", result, lhs, rhs),
            Instr::I32NeImm { result, lhs, rhs } => self.write_binary(f, "i32.ne", result, lhs, rhs),
            Instr::I32LtS { result, lhs, rhs } => self.write_binary(f, "i32.lt_s", result, lhs, rhs),
            Instr::I32LtSImm { result, lhs, rhs } => self.write_binary(f, "i32.lt_s", result, lhs, rhs),
            Instr::I32LtU { result, lhs, rhs } => self.write_binary(f, "i32.lt_u", result, lhs, rhs),
            Instr::I32LtUImm { result, lhs, rhs } => self.write_binary(f, "i32.lt_u", result, lhs, rhs),
            Instr::I32GtS { result, lhs, rhs } => self.write_binary(f, "i32.gt_s", result, lhs, rhs),
            Instr::I32GtSImm { result, lhs, rhs } => self.write_binary(f, "i32.gt_s", result, lhs, rhs),
            Instr::I32GtU { result, lhs, rhs } => self.write_binary(f, "i32.gt_u", result, lhs, rhs),
            Instr::I32GtUImm { result, lhs, rhs } => self.write_binary(f, "i32.gt_u", result, lhs, rhs),
            Instr::I32LeS { result, lhs, rhs } => self.write_binary(f, "i32.le_s", result, lhs, rhs),
            Instr::I32LeSImm { result, lhs, rhs } => self.write_binary(f, "i32.le_s", result, lhs, rhs),
            Instr::I32LeU { result, lhs, rhs } => self.write_binary(f, "i32.le_u", result, lhs, rhs),
            Instr::I32LeUImm { result, lhs, rhs } => self.write_binary(f, "i32.le_u", result, lhs, rhs),
            Instr::I32GeS { result, lhs, rhs } => self.write_binary(f, "i32.ge_s", result, lhs, rhs),
            Instr::I32GeSImm { result, lhs, rhs } => self.write_binary(f, "i32.ge_s", result, lhs, rhs),
            Instr::I32GeU { result, lhs, rhs } => self.write_binary(f, "i32.ge_u", result, lhs, rhs),
            Instr::I32GeUImm { result, lhs, rhs } => self.write_binary(f, "i32.ge_u", result, lhs, rhs),
            Instr::I64Eq { result, lhs, rhs } => self.write_binary(f, "i64.eq", result, lhs, rhs),
            Instr::I64EqImm { result, lhs, rhs } => self.write_binary(f, "i64.eq", result, lhs, rhs),
            Instr::I64Ne { result, lhs, rhs } => self.write_binary(f, "i64.ne", result, lhs, rhs),
            Instr::I64NeImm { result, lhs, rhs } => self.write_binary(f, "i64.ne", result, lhs, rhs),
            Instr::I64LtS { result, lhs, rhs } => self.write_binary(f, "i64.lt_s", result, lhs, rhs),
            Instr::I64LtSImm { result, lhs, rhs } => self.write_binary(f, "i64.lt_s", result, lhs, rhs),
            Instr::I64LtU { result, lhs, rhs } => self.write_binary(f, "i64.lt_u", result, lhs, rhs),
            Instr::I64LtUImm { result, lhs, rhs } => self.write_binary(f, "i64.lt_u", result, lhs, rhs),
            Instr::I64GtS { result, lhs, rhs } => self.write_binary(f, "i64.gt_s", result, lhs, rhs),
            Instr::I64GtSImm { result, lhs, rhs } => self.write_binary(f, "i64.gt_s", result, lhs, rhs),
            Instr::I64GtU { result, lhs, rhs } => self.write_binary(f, "i64.gt_u", result, lhs, rhs),
            Instr::I64GtUImm { result, lhs, rhs } => self.write_binary(f, "i64.gt_u", result, lhs, rhs),
            Instr::I64LeS { result, lhs, rhs } => self.write_binary(f, "i64.le_s", result, lhs, rhs),
            Instr::I64LeSImm { result, lhs, rhs } => self.write_binary(f, "i64.le_s", result, lhs, rhs),
            Instr::I64LeU { result, lhs, rhs } => self.write_binary(f, "i64.le_u", result, lhs, rhs),
            Instr::I64LeUImm { result, lhs, rhs } => self.write_binary(f, "i64.le_u", result, lhs, rhs),
            Instr::I64GeS { result, lhs, rhs } => self.write_binary(f, "i64.ge_s", result, lhs, rhs),
            Instr::I64GeSImm { result, lhs, rhs } => self.write_binary(f, "i64.ge_s", result, lhs, rhs),
            Instr::I64GeU { result, lhs, rhs } => self.write_binary(f, "i64.ge_u", result, lhs, rhs),
            Instr::I64GeUImm { result, lhs, rhs } => self.write_binary(f, "i64.ge_u", result, lhs, rhs),
            Instr::F32Eq { result, lhs, rhs } => self.write_binary(f, "f32.eq", result, lhs, rhs),
            Instr::F32EqImm { result, lhs, rhs } => self.write_binary(f, "f32.eq", result, lhs, rhs),
            Instr::F32Ne { result, lhs, rhs } => self.write_binary(f, "f32.ne", result, lhs, rhs),
            Instr::F32NeImm { result, lhs, rhs } => self.write_binary(f, "f32.ne", result, lhs, rhs),
            Instr::F32Lt { result, lhs, rhs } => self.write_binary(f, "f32.lt", result, lhs, rhs),
            Instr::F32LtImm { result, lhs, rhs } => self.write_binary(f, "f32.lt", result, lhs, rhs),
            Instr::F32Gt { result, lhs, rhs } => self.write_binary(f, "f32.gt", result, lhs, rhs),
            Instr::F32GtImm { result, lhs, rhs } => self.write_binary(f, "f32.gt", result, lhs, rhs),
            Instr::F32Le { result, lhs, rhs } => self.write_binary(f, "f32.le", result, lhs, rhs),
            Instr::F32LeImm { result, lhs, rhs } => self.write_binary(f, "f32.le", result, lhs, rhs),
            Instr::F32Ge { result, lhs, rhs } => self.write_binary(f, "f32.ge", result, lhs, rhs),
            Instr::F32GeImm { result, lhs, rhs } => self.write_binary(f, "f32.ge", result, lhs, rhs),
            Instr::F64Eq { result, lhs, rhs } => self.write_binary(f, "f64.eq", result, lhs, rhs),
            Instr::F64EqImm { result, lhs, rhs } => self.write_binary(f, "f64.eq", result, lhs, rhs),
            Instr::F64Ne { result, lhs, rhs } => self.write_binary(f, "f64.ne", result, lhs, rhs),
            Instr::F64NeImm { result, lhs, rhs } => self.write_binary(f, "f64.ne", result, lhs, rhs),
            Instr::F64Lt { result, lhs, rhs } => self.write_binary(f, "f64.lt", result, lhs, rhs),
            Instr::F64LtImm { result, lhs, rhs } => self.write_binary(f, "f64.lt", result, lhs, rhs),
            Instr::F64Gt { result, lhs, rhs } => self.write_binary(f, "f64.gt", result, lhs, rhs),
            Instr::F64GtImm { result, lhs, rhs } => self.write_binary(f, "f64.gt", result, lhs, rhs),
            Instr::F64Le { result, lhs, rhs } => self.write_binary(f, "f64.le", result, lhs, rhs),
            Instr::F64LeImm { result, lhs, rhs } => self.write_binary(f, "f64.le", result, lhs, rhs),
            Instr::F64Ge { result, lhs, rhs } => self.write_binary(f, "f64.ge", result, lhs, rhs),
            Instr::F64GeImm { result, lhs, rhs } => self.write_binary(f, "f64.ge", result, lhs, rhs),
            ...
            Instr::I32AddImm { result, lhs, rhs } => self.write_binary(f, "i32.add", result, lhs, rhs),
            Instr::I32Sub { result, lhs, rhs } => self.write_binary(f, "i32.sub", result, lhs, rhs),
            Instr::I32SubImm { result, lhs, rhs } => self.write_binary(f, "i32.sub", result, lhs, rhs),
            Instr::I32Mul { result, lhs, rhs } => self.write_binary(f, "i32.mul", result, lhs, rhs),
            Instr::I32MulImm { result, lhs, rhs } => self.write_binary(f, "i32.mul", result, lhs, rhs),
            Instr::I32DivS { result, lhs, rhs } => self.write_binary(f, "i32.div_s", result, lhs, rhs),
            Instr::I32DivSImm { result, lhs, rhs } => self.write_binary(f, "i32.div_s", result, lhs, rhs),
            Instr::I32DivU { result, lhs, rhs } => self.write_binary(f, "i32.div_u", result, lhs, rhs),
            Instr::I32DivUImm { result, lhs, rhs } => self.write_binary(f, "i32.div_u", result, lhs, rhs),
            Instr::I32RemS { result, lhs, rhs } => self.write_binary(f, "i32.rem_s", result, lhs, rhs),
            Instr::I32RemSImm { result, lhs, rhs } => self.write_binary(f, "i32.rem_s", result, lhs, rhs),
            Instr::I32RemU { result, lhs, rhs } => self.write_binary(f, "i32.rem_u", result, lhs, rhs),
            Instr::I32RemUImm { result, lhs, rhs } => self.write_binary(f, "i32.rem_u", result, lhs, rhs),
            Instr::I32And { result, lhs, rhs } => self.write_binary(f, "i32.and", result, lhs, rhs),
            Instr::I32AndImm { result, lhs, rhs } => self.write_binary(f, "i32.and", result, lhs, rhs),
            Instr::I32Or { result, lhs, rhs } => self.write_binary(f, "i32.or", result, lhs, rhs),
            Instr::I32OrImm { result, lhs, rhs } => self.write_binary(f, "i32.or", result, lhs, rhs),
            Instr::I32Xor { result, lhs, rhs } => self.write_binary(f, "i32.xor", result, lhs, rhs),
            Instr::I32XorImm { result, lhs, rhs } => self.write_binary(f, "i32.xor", result, lhs, rhs),
            Instr::I32Shl { result, lhs, rhs } => self.write_binary(f, "i32.shl", result, lhs, rhs),
            Instr::I32ShlImm { result, lhs, rhs } => self.write_binary(f, "i32.shl", result, lhs, rhs),
            Instr::I32ShrS { result, lhs, rhs } => self.write_binary(f, "i32.shr_s", result, lhs, rhs),
            Instr::I32ShrSImm { result, lhs, rhs } => self.write_binary(f, "i32.shr_s", result, lhs, rhs),
            Instr::I32ShrU { result, lhs, rhs } => self.write_binary(f, "i32.shr_u", result, lhs, rhs),
            Instr::I32ShrUImm { result, lhs, rhs } => self.write_binary(f, "i32.shr_u", result, lhs, rhs),
            Instr::I32Rotl { result, lhs, rhs } => self.write_binary(f, "i32.rotl", result, lhs, rhs),
            Instr::I32RotlImm { result, lhs, rhs } => self.write_binary(f, "i32.rotl", result, lhs, rhs),
            Instr::I32Rotr { result, lhs, rhs } => self.write_binary(f, "i32.rotr", result, lhs, rhs),
            Instr::I32RotrImm { result, lhs, rhs } => self.write_binary(f, "i32.rotr", result, lhs, rhs),
            ...
            Instr::I64AddImm { result, lhs, rhs } => self.write_binary(f, "i64.add", result, lhs, rhs),
            Instr::I64Sub { result, lhs, rhs } => self.write_binary(f, "i64.sub", result, lhs, rhs),
            Instr::I64SubImm { result, lhs, rhs } => self.write_binary(f, "i64.sub", result, lhs, rhs),
            Instr::I64Mul { result, lhs, rhs } => self.write_binary(f, "i64.mul", result, lhs, rhs),
            Instr::I64MulImm { result, lhs, rhs } => self.write_binary(f, "i64.mul", result, lhs, rhs),
            Instr::I64DivS { result, lhs, rhs } => self.write_binary(f, "i64.div_s", result, lhs, rhs),
            Instr::I64DivSImm { result, lhs, rhs } => self.write_binary(f, "i64.div_s", result, lhs, rhs),
            Instr::I64DivU { result, lhs, rhs } => self.write_binary(f, "i64.div_u", result, lhs, rhs),
            Instr::I64DivUImm { result, lhs, rhs } => self.write_binary(f, "i64.div_u", result, lhs, rhs),
            Instr::I64RemS { result, lhs, rhs } => self.write_binary(f, "i64.rem_s", result, lhs, rhs),
            Instr::I64RemSImm { result, lhs, rhs } => self.write_binary(f, "i64.rem_s", result, lhs, rhs),
            Instr::I64RemU { result, lhs, rhs } => self.write_binary(f, "i64.rem_u", result, lhs, rhs),
            Instr::I64RemUImm { result, lhs, rhs } => self.write_binary(f, "i64.rem_u", result, lhs, rhs),
            Instr::I64And { result, lhs, rhs } => self.write_binary(f, "i64.and", result, lhs, rhs),
            Instr::I64AndImm { result, lhs, rhs } => self.write_binary(f, "i64.and", result, lhs, rhs),
            Instr::I64Or { result, lhs, rhs } => self.write_binary(f, "i64.or", result, lhs, rhs),
            Instr::I64OrImm { result, lhs, rhs } => self.write_binary(f, "i64.or", result, lhs, rhs),
            Instr::I64Xor { result, lhs, rhs } => self.write_binary(f, "i64.xor", result, lhs, rhs),
            Instr::I64XorImm { result, lhs, rhs } => self.write_binary(f, "i64.xor", result, lhs, rhs),
            Instr::I64Shl { result, lhs, rhs } => self.write_binary(f, "i64.shl", result, lhs, rhs),
            Instr::I64ShlImm { result, lhs, rhs } => self.write_binary(f, "i64.shl", result, lhs, rhs),
            Instr::I64ShrS { result, lhs, rhs } => self.write_binary(f, "i64.shr_s", result, lhs, rhs),
            Instr::I64ShrSImm { result, lhs, rhs } => self.write_binary(f, "i64.shr_s", result, lhs, rhs),
            Instr::I64ShrU { result, lhs, rhs } => self.write_binary(f, "i64.shr_u", result, lhs, rhs),
            Instr::I64ShrUImm { result, lhs, rhs } => self.write_binary(f, "i64.shr_u", result, lhs, rhs),
            Instr::I64Rotl { result, lhs, rhs } => self.write_binary(f, "i64.rotl", result, lhs, rhs),
            Instr::I64RotlImm { result, lhs, rhs } => self.write_binary(f, "i64.rotl", result, lhs, rhs),
            Instr::I64Rotr { result, lhs, rhs } => self.write_binary(f, "i64.rotr", result, lhs, rhs),
            Instr::I64RotrImm { result, lhs, rhs } => self.write_binary(f, "i64.rotr", result, lhs, rhs),
            ...
            Instr::F32AddImm { result, lhs, rhs } => self.write_binary(f, "f32.add", result, lhs, rhs),
            Instr::F32Sub { result, lhs, rhs } => self.write_binary(f, "f32.sub", result, lhs, rhs),
            Instr::F32SubImm { result, lhs, rhs } => self.write_binary(f, "f32.sub", result, lhs, rhs),
            Instr::F32Mul { result, lhs, rhs } => self.write_binary(f, "f32.mul", result, lhs, rhs),
            Instr::F32MulImm { result, lhs, rhs } => self.write_binary(f, "f32.mul", result, lhs, rhs),
            Instr::F32Div { result, lhs, rhs } => self.write_binary(f, "f32.div", result, lhs, rhs),
            Instr::F32DivImm { result, lhs, rhs } => self.write_binary(f, "f32.div", result, lhs, rhs),
            Instr::F32Min { result, lhs, rhs } => self.write_binary(f, "f32.min", result, lhs, rhs),
            Instr::F32MinImm { result, lhs, rhs } => self.write_binary(f, "f32.min", result, lhs, rhs),
            Instr::F32Max { result, lhs, rhs } => self.write_binary(f, "f32.max", result, lhs, rhs),
            Instr::F32MaxImm { result, lhs, rhs } => self.write_binary(f, "f32.max", result, lhs, rhs),
            Instr::F32Copysign { result, lhs, rhs } => self.write_binary(f, "f32.copysign", result, lhs, rhs),
            Instr::F32CopysignImm { result, lhs, rhs } => self.write_binary(f, "f32.copysign", result, lhs, rhs),
            ...
            Instr::F64AddImm { result, lhs, rhs } => self.write_binary(f, "f64.add", result, lhs, rhs),
            Instr::F64Sub { result, lhs, rhs } => self.write_binary(f, "f64.sub", result, lhs, rhs),
            Instr::F64SubImm { result, lhs, rhs } => self.write_binary(f, "f64.sub", result, lhs, rhs),
            Instr::F64Mul { result, lhs, rhs } => self.write_binary(f, "f64.mul", result, lhs, rhs),
            Instr::F64MulImm { result, lhs, rhs } => self.write_binary(f, "f64.mul", result, lhs, rhs),
            Instr::F64Div { result, lhs, rhs } => self.write_binary(f, "f64.div", result, lhs, rhs),
            Instr::F64DivImm { result, lhs, rhs } => self.write_binary(f, "f64.div", result, lhs, rhs),
            Instr::F64Min { result, lhs, rhs } => self.write_binary(f, "f64.min", result, lhs, rhs),
            Instr::F64MinImm { result, lhs, rhs } => self.write_binary(f, "f64.min", result, lhs, rhs),
            Instr::F64Max { result, lhs, rhs } => self.write_binary(f, "f64.max", result, lhs, rhs),
            Instr::F64MaxImm { result, lhs, rhs } => self.write_binary(f, "f64.max", result, lhs, rhs),
            Instr::F64Copysign { result, lhs, rhs } => self.write_binary(f, "f64.copysign", result, lhs, rhs),
            Instr::F64CopysignImm { result, lhs, rhs } => self.write_binary(f, "f64.copysign", result, lhs, rhs),
