...
impl<'alloc, 'parser> FunctionTranslator<'alloc, 'parser> {
    ...
    fn translate_operator(&mut self, operator: Operator) -> Result<(), ModuleError> {
        ...
        match operator {
            ...
            Operator::MemorySize { mem, mem_byte } => self.translate_memory_size(mem),
            Operator::MemoryGrow { mem, mem_byte } => self.translate_memory_grow(mem),
            ...
            Operator::I32LtS => self.translate_i32_lt_s(),
            Operator::I32LtU => self.translate_i32_lt_u(),
            Operator::I32GtS => self.translate_i32_gt_s(),
            Operator::I32GtU => self.translate_i32_gt_u(),
            Operator::I32LeS => self.translate_i32_le_s(),
            Operator::I32LeU => self.translate_i32_le_u(),
            Operator::I32GeS => self.translate_i32_ge_s(),
            Operator::I32GeU => self.translate_i32_ge_u(),
            Operator::I64Eqz => self.translate_i64_eqz(),
            Operator::I64Eq => self.translate_i64_eq(),
            Operator::I64Ne => self.translate_i64_ne(),
            Operator::I64LtS => self.translate_i64_lt_s(),
            Operator::I64LtU => self.translate_i64_lt_u(),
            Operator::I64GtS => self.translate_i64_gt_s(),
            Operator::I64GtU => self.translate_i64_gt_u(),
            Operator::I64LeS => self.translate_i64_le_s(),
            Operator::I64LeU => self.translate_i64_le_u(),
            Operator::I64GeS => self.translate_i64_ge_s(),
            Operator::I64GeU => self.translate_i64_ge_u(),
            ...
            Operator::I32DivS => self.translate_i32_div_s(),
            Operator::I32DivU => self.translate_i32_div_u(),
            Operator::I32RemS => self.translate_i32_rem_s(),
            Operator::I32RemU => self.translate_i32_rem_u(),
            ...
            Operator::I32ShrS => self.translate_i32_shr_s(),
            Operator::I32ShrU => self.translate_i32_shr_u(),
            ...
            Operator::I64DivS => self.translate_i64_div_s(),
            Operator::I64DivU => self.translate_i64_div_u(),
            Operator::I64RemS => self.translate_i64_rem_s(),
            Operator::I64RemU => self.translate_i64_rem_u(),
            ...
            Operator::I64ShrS => self.translate_i64_shr_s(),
            Operator::I64ShrU => self.translate_i64_shr_u(),
            ...
            Operator::I32TruncF32S => self.translate_i32_trunc_f32_s(),
            Operator::I32TruncF32U => self.translate_i32_trunc_f32_u(),
            Operator::I32TruncF64S => self.translate_i32_trunc_f64_s(),
            Operator::I32TruncF64U => self.translate_i32_trunc_f64_u(),
            Operator::I64ExtendI32S => self.translate_i64_extend_i32_s(),
            Operator::I64ExtendI32U => self.translate_i64_extend_i32_u(),
            Operator::I64TruncF32S => self.translate_i64_trunc_f32_s(),
            Operator::I64TruncF32U => self.translate_i64_trunc_f32_u(),
            Operator::I64TruncF64S => self.translate_i64_trunc_f64_s(),
            Operator::I64TruncF64U => self.translate_i64_trunc_f64_u(),
            Operator::F32ConvertI32S => self.translate_f32_convert_i32_s(),
            Operator::F32ConvertI32U => self.translate_f32_convert_i32_u(),
            Operator::F32ConvertI64S => self.translate_f32_convert_i64_s(),
            Operator::F32ConvertI64U => self.translate_f32_convert_i64_u(),
            Operator::F32DemoteF64 => self.translate_f32_demote_f64(),
            Operator::F64ConvertI32S => self.translate_f64_convert_i32_s(),
            Operator::F64ConvertI32U => self.translate_f64_convert_i32_u(),
            Operator::F64ConvertI64S => self.translate_f64_convert_i64_s(),
            Operator::F64ConvertI64U => self.translate_f64_convert_i64_u(),
            ...
            Operator::I32TruncSatF32S => self.translate_i32_trunc_sat_f32_s(),
            Operator::I32TruncSatF32U => self.translate_i32_trunc_sat_f32_u(),
            Operator::I32TruncSatF64S => self.translate_i32_trunc_sat_f64_s(),
            Operator::I32TruncSatF64U => self.translate_i32_trunc_sat_f64_u(),
            Operator::I64TruncSatF32S => self.translate_i64_trunc_sat_f32_s(),
            Operator::I64TruncSatF32U => self.translate_i64_trunc_sat_f32_u(),
            Operator::I64TruncSatF64S => self.translate_i64_trunc_sat_f64_s(),
            Operator::I64TruncSatF64U => self.translate_i64_trunc_sat_f64_u(),
            Operator::I32Extend8S => self.translate_i32_extend8_s(),
            Operator::I32Extend16S => self.translate_i32_extend16_s(),
            Operator::I64Extend8S => self.translate_i64_extend8_s(),
            Operator::I64Extend16S => self.translate_i64_extend16_s(),
            Operator::I64Extend32S => self.translate_i64_extend32_s(),
            Operator::MemoryInit { .. }
            | Operator::DataDrop { .. }
            | Operator::MemoryCopy { .. }
            | Operator::MemoryFill { .. }
