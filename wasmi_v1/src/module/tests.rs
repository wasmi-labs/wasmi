...
fn implicit_return_no_value() {
    ...
    let expected = [Instruction::ReturnEmpty(DropKeep::new(0, 0))];
...
fn implicit_return_param() {
    ...
    let expected = [Instruction::ReturnEmpty(DropKeep::new(1, 0))];
    assert_func_bodies(&wasm, [expected]);
}
...
fn get_local_3() {
    ...
    let expected = [
        ...
        Instruction::Drop,
        Instruction::Drop,
        Instruction::ReturnEmpty(DropKeep::new(2, 0)),
    ];
    assert_func_bodies(&wasm, [expected]);
}
...
fn if_without_else() {
    ...
    let expected = [
        /* 0 */ Instruction::constant_empty(1),
        /* 1 */ Instruction::BrIfEqz(target!(4, drop: 0, keep: 0)),
        /* 2 */ Instruction::constant_empty(2),
        /* 3 */ Instruction::Return(DropKeep::new(1, 1)),
        /* 4 */ Instruction::constant_empty(3),
...
fn if_else() {
    ...
    let expected = [
        Instruction::constant_empty(1),
        Instruction::BrIfEqz(target!(5, drop: 0, keep: 0)),
        Instruction::constant_empty(2),
        Instruction::local_set(1),
        Instruction::Br(target!(7, drop: 0, keep: 0)),
        Instruction::constant_empty(3),
        Instruction::local_set(1),
        Instruction::ReturnEmpty(DropKeep::new(1, 0)),
    ];
    assert_func_bodies(&wasm, [expected]);
}
...
fn if_else_returns_result() {
    ...
    let expected = [
        ...
        /* 4 */ Instruction::constant_empty(3),
        /* 5 */ Instruction::Drop,
        /* 6 */ Instruction::ReturnEmpty(DropKeep::new(0, 0)),
    ];
    assert_func_bodies(&wasm, [expected]);
}
...
fn if_else_branch_from_true_branch() {
    ...
    let expected = [
        ...
        /*  2 */ Instruction::constant_empty(1),
        /*  3 */ Instruction::constant(1),
        /*  4 */ Instruction::BrIfNez(target!(9, drop: 0, keep: 1)),
        /*  5 */ Instruction::Drop,
        /*  6 */ Instruction::constant_empty(2),
        /*  7 */ Instruction::Br(target!(9, drop: 0, keep: 0)),
        /*  8 */ Instruction::constant_empty(3),
        /*  9 */ Instruction::Drop,
        /* 10 */ Instruction::ReturnEmpty(DropKeep::new(0, 0)),
    ];
    assert_func_bodies(&wasm, [expected]);
}
...
fn if_else_branch_from_false_branch() {
    ...
    let expected = [
        ...
        /*  4 */ Instruction::constant_empty(2),
...
fn if_else_both_unreachable_before_end() {
    ...
    let expected = [
        /* 0 */ Instruction::local_get_empty(1),
        /* 1 */ Instruction::BrIfEqz(target!(4, drop: 0, keep: 0)),
        /* 2 */ Instruction::constant_empty(1),
        /* 3 */ Instruction::Return(DropKeep::new(1, 1)),
        /* 4 */ Instruction::constant_empty(2),
        /* 5 */ Instruction::Return(DropKeep::new(1, 1)),
        /* 6 */ Instruction::Drop,
        /* 7 */ Instruction::constant_empty(3),
...
fn loop_() {
    ...
    let expected = [
        ...
        Instruction::constant_empty(2),
        Instruction::Drop,
        Instruction::ReturnEmpty(DropKeep::new(0, 0)),
    ];
    assert_func_bodies(&wasm, [expected]);
}
...
fn spec_as_br_if_value_cond() {
    ...
    let expected = [
        /* 0 */ Instruction::constant_empty(6),
...
fn br_table_returns_result() {
    ...
    let expected = [
        ...
        /* 6 */ Instruction::Drop,
        /* 7 */ Instruction::ReturnEmpty(DropKeep::new(0, 0)),
    ];
    assert_func_bodies(&wasm, [expected]);
}
...
fn br_table_return() {
    ...
    let expected = [
        ...
        /* 5 */ Instruction::ReturnEmpty(DropKeep::new(1, 0)),
    ];
    assert_func_bodies(&wasm, [expected]);
}
