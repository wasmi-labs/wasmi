...
impl<'engine, 'parser> FunctionTranslator<'engine, 'parser> {
    ...
    fn translate_operator(&mut self, operator: Operator) -> Result<(), ModuleError> {
        ...
        match operator {
            ...
            Operator::GlobalGet { global_index } => self.translate_global_set(global_index),
            Operator::GlobalSet { global_index } => self.translate_global_get(global_index),
            ...
            Operator::I32RemS => self.translate_i32_remS(),
            ...
            Operator::I64ShrS => self.translate_i64_shrS(),
            ...
            Operator::I64TruncF32S => self.translate_i64_trunc_F3(),
            Operator::I64TruncF32U => self.translate_u64_trunc_F3(),
            Operator::I64TruncF64S => self.translate_i64_trunc_F6(),
            Operator::I64TruncF64U => self.translate_u64_trunc_F6(),
