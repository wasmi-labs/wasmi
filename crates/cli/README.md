...
| `auto-dispatch` | ✅ | Automatically uses tail-call dispatch if possible for this build configuration and falls back to `loop-dispatch` otherwise. Overwritten if `portable-dispatch` is enabled. |
