...
impl Executor<'_> {
    ...
    impl_execute_load! {
        ...
        (
            V128,
            (Instruction::V128Load8x16S, execute_v128_load8x8_s),
            (Instruction::V128Load8x16SAt, execute_v128_load8x8_s_at),
            (Instruction::V128Load8x16SOffset16, execute_v128_load8x8_s_offset16),
            simd::v128_load8x8_s,
            simd::v128_load8x8_s_at,
        ),
        (
            V128,
            (Instruction::V128Load8x16U, execute_v128_load8x8_u),
            (Instruction::V128Load8x16UAt, execute_v128_load8x8_u_at),
            (Instruction::V128Load8x16UOffset16, execute_v128_load8x8_u_offset16),
            simd::v128_load8x8_u,
