...
impl Executor<'_> {
    impl_execute_load! {
        (
            ...
            (Instruction::Load32At, load32_at),
            (Instruction::Load32Offset16, load32_offset16),
            UntypedVal::load32,
        ),
        (
            (Instruction::Load64, load64),
            (Instruction::Load64At, load64_at),
            (Instruction::Load64Offset16, load64_offset16),
            UntypedVal::load64,
        ),

        (
            (Instruction::I32Load8s, i32_load8_s),
            (Instruction::I32Load8sAt, i32_load8_s_at),
            (Instruction::I32Load8sOffset16, i32_load8_s_offset16),
            UntypedVal::i32_load8_s,
        ),
        (
            (Instruction::I32Load8u, i32_load8_u),
            (Instruction::I32Load8uAt, i32_load8_u_at),
            (Instruction::I32Load8uOffset16, i32_load8_u_offset16),
            UntypedVal::i32_load8_u,
        ),
        (
            (Instruction::I32Load16s, i32_load16_s),
            (Instruction::I32Load16sAt, i32_load16_s_at),
            (Instruction::I32Load16sOffset16, i32_load16_s_offset16),
            UntypedVal::i32_load16_s,
        ),
        (
            (Instruction::I32Load16u, i32_load16_u),
            (Instruction::I32Load16uAt, i32_load16_u_at),
            (Instruction::I32Load16uOffset16, i32_load16_u_offset16),
            UntypedVal::i32_load16_u,
        ),

        (
            (Instruction::I64Load8s, i64_load8_s),
            (Instruction::I64Load8sAt, i64_load8_s_at),
            (Instruction::I64Load8sOffset16, i64_load8_s_offset16),
            UntypedVal::i64_load8_s,
        ),
        (
            (Instruction::I64Load8u, i64_load8_u),
            (Instruction::I64Load8uAt, i64_load8_u_at),
            (Instruction::I64Load8uOffset16, i64_load8_u_offset16),
            UntypedVal::i64_load8_u,
        ),
        (
            (Instruction::I64Load16s, i64_load16_s),
            (Instruction::I64Load16sAt, i64_load16_s_at),
            (Instruction::I64Load16sOffset16, i64_load16_s_offset16),
            UntypedVal::i64_load16_s,
        ),
        (
            (Instruction::I64Load16u, i64_load16_u),
            (Instruction::I64Load16uAt, i64_load16_u_at),
            (Instruction::I64Load16uOffset16, i64_load16_u_offset16),
            UntypedVal::i64_load16_u,
        ),
        (
            (Instruction::I64Load32s, i64_load32_s),
            (Instruction::I64Load32sAt, i64_load32_s_at),
            (Instruction::I64Load32sOffset16, i64_load32_s_offset16),
            UntypedVal::i64_load32_s,
        ),
        (
            (Instruction::I64Load32u, i64_load32_u),
            (Instruction::I64Load32uAt, i64_load32_u_at),
            (Instruction::I64Load32uOffset16, i64_load32_u_offset16),
