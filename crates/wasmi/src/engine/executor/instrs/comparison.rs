...
impl Executor<'_> {
    impl_comparison_imm16! {
        ...
        (i32, Instruction::I32LtSImm16Rhs, execute_i32_lt_s_imm16, UntypedVal::i32_lt_s),
        (u32, Instruction::I32LtUImm16Rhs, execute_i32_lt_u_imm16, UntypedVal::i32_lt_u),
        (i32, Instruction::I32LeSImm16Rhs, execute_i32_le_s_imm16, UntypedVal::i32_le_s),
        (u32, Instruction::I32LeUImm16Rhs, execute_i32_le_u_imm16, UntypedVal::i32_le_u),
        (i32, Instruction::I32GtSImm16Rhs, execute_i32_gt_s_imm16, UntypedVal::i32_gt_s),
        (u32, Instruction::I32GtUImm16Rhs, execute_i32_gt_u_imm16, UntypedVal::i32_gt_u),
        (i32, Instruction::I32GeSImm16Rhs, execute_i32_ge_s_imm16, UntypedVal::i32_ge_s),
        (u32, Instruction::I32GeUImm16Rhs, execute_i32_ge_u_imm16, UntypedVal::i32_ge_u),
        ...
        (i64, Instruction::I64LtSImm16Rhs, execute_i64_lt_s_imm16, UntypedVal::i64_lt_s),
        (u64, Instruction::I64LtUImm16Rhs, execute_i64_lt_u_imm16, UntypedVal::i64_lt_u),
        (i64, Instruction::I64LeSImm16Rhs, execute_i64_le_s_imm16, UntypedVal::i64_le_s),
        (u64, Instruction::I64LeUImm16Rhs, execute_i64_le_u_imm16, UntypedVal::i64_le_u),
        (i64, Instruction::I64GtSImm16Rhs, execute_i64_gt_s_imm16, UntypedVal::i64_gt_s),
        (u64, Instruction::I64GtUImm16Rhs, execute_i64_gt_u_imm16, UntypedVal::i64_gt_u),
        (i64, Instruction::I64GeSImm16Rhs, execute_i64_ge_s_imm16, UntypedVal::i64_ge_s),
        (u64, Instruction::I64GeUImm16Rhs, execute_i64_ge_u_imm16, UntypedVal::i64_ge_u),
    }
}
