...
fn cmp_i32_not_and(a: i32, b: i32) -> bool {
    !cmp_i32_and(a, b)
}

fn cmp_i32_not_or(a: i32, b: i32) -> bool {
    !cmp_i32_or(a, b)
}

fn cmp_i32_not_xor(a: i32, b: i32) -> bool {
    !cmp_i32_xor(a, b)
}
...
impl_execute_branch_binop! {
    ...
    (i32, Instruction::BranchI32AndEqz, execute_branch_i32_and_eqz, cmp_i32_not_and),
    (i32, Instruction::BranchI32OrEqz, execute_branch_i32_or_eqz, cmp_i32_not_or),
    (i32, Instruction::BranchI32XorEqz, execute_branch_i32_xor_eqz, cmp_i32_not_xor),
...
impl_execute_branch_binop_imm16_rhs! {
    ...
    (i32, Instruction::BranchI32AndEqzImm16, execute_branch_i32_and_eqz_imm16, cmp_i32_not_and),
    (i32, Instruction::BranchI32OrEqzImm16, execute_branch_i32_or_eqz_imm16, cmp_i32_not_or),
    (i32, Instruction::BranchI32XorEqzImm16, execute_branch_i32_xor_eqz_imm16, cmp_i32_not_xor),
...
impl Executor<'_> {
    ...
    pub fn execute_branch_cmp_fallback(&mut self, lhs: Reg, rhs: Reg, params: Reg) {
        ...
        match params.cmp {
            ...
            C::I32BitAnd => self.execute_branch_binop::<i32>(lhs, rhs, offset, cmp_i32_and),
            C::I32BitOr => self.execute_branch_binop::<i32>(lhs, rhs, offset, cmp_i32_or),
            C::I32BitXor => self.execute_branch_binop::<i32>(lhs, rhs, offset, cmp_i32_xor),
            C::I32BitAndEqz => self.execute_branch_binop::<i32>(lhs, rhs, offset, cmp_i32_not_and),
            C::I32BitOrEqz => self.execute_branch_binop::<i32>(lhs, rhs, offset, cmp_i32_not_or),
            C::I32BitXorEqz => self.execute_branch_binop::<i32>(lhs, rhs, offset, cmp_i32_not_xor),
