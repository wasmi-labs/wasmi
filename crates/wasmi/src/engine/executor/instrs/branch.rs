...
impl_execute_branch_binop! {
    (i32, Instruction::BranchI32And, execute_branch_i32_and, <i32 as UntypedValueExt>::and),
    (i32, Instruction::BranchI32Or, execute_branch_i32_or, <i32 as UntypedValueExt>::or),
    (i32, Instruction::BranchI32Xor, execute_branch_i32_xor, <i32 as UntypedValueExt>::xor),
    (i32, Instruction::BranchI32Nand, execute_branch_i32_nand, <i32 as UntypedValueExt>::nand),
    (i32, Instruction::BranchI32Nor, execute_branch_i32_nor, <i32 as UntypedValueExt>::nor),
    (i32, Instruction::BranchI32Xnor, execute_branch_i32_xnor, <i32 as UntypedValueExt>::xnor),
    ...
    (i64, Instruction::BranchI64And, execute_branch_i64_and, <i64 as UntypedValueExt>::and),
    (i64, Instruction::BranchI64Or, execute_branch_i64_or, <i64 as UntypedValueExt>::or),
    (i64, Instruction::BranchI64Xor, execute_branch_i64_xor, <i64 as UntypedValueExt>::xor),
    (i64, Instruction::BranchI64Nand, execute_branch_i64_nand, <i64 as UntypedValueExt>::nand),
    (i64, Instruction::BranchI64Nor, execute_branch_i64_nor, <i64 as UntypedValueExt>::nor),
    (i64, Instruction::BranchI64Xnor, execute_branch_i64_xnor, <i64 as UntypedValueExt>::xnor),
...
impl_execute_branch_binop_imm16_rhs! {
    (i32, Instruction::BranchI32AndImm16, execute_branch_i32_and_imm16, <i32 as UntypedValueExt>::and),
    (i32, Instruction::BranchI32OrImm16, execute_branch_i32_or_imm16, <i32 as UntypedValueExt>::or),
    (i32, Instruction::BranchI32XorImm16, execute_branch_i32_xor_imm16, <i32 as UntypedValueExt>::xor),
    (i32, Instruction::BranchI32NandImm16, execute_branch_i32_nand_imm16, <i32 as UntypedValueExt>::nand),
    (i32, Instruction::BranchI32NorImm16, execute_branch_i32_nor_imm16, <i32 as UntypedValueExt>::nor),
    (i32, Instruction::BranchI32XnorImm16, execute_branch_i32_xnor_imm16, <i32 as UntypedValueExt>::xnor),
    ...
    (i64, Instruction::BranchI64AndImm16, execute_branch_i64_and_imm16, <i64 as UntypedValueExt>::and),
    (i64, Instruction::BranchI64OrImm16, execute_branch_i64_or_imm16, <i64 as UntypedValueExt>::or),
    (i64, Instruction::BranchI64XorImm16, execute_branch_i64_xor_imm16, <i64 as UntypedValueExt>::xor),
    (i64, Instruction::BranchI64NandImm16, execute_branch_i64_nand_imm16, <i64 as UntypedValueExt>::nand),
    (i64, Instruction::BranchI64NorImm16, execute_branch_i64_nor_imm16, <i64 as UntypedValueExt>::nor),
    (i64, Instruction::BranchI64XnorImm16, execute_branch_i64_xnor_imm16, <i64 as UntypedValueExt>::xnor),
...
impl Executor<'_> {
    ...
    pub fn execute_branch_cmp_fallback(&mut self, lhs: Reg, rhs: Reg, params: Reg) {
        ...
        match params.cmp {
            ...
            C::I32And => {
                self.execute_branch_binop::<i32>(lhs, rhs, offset, <i32 as UntypedValueExt>::and)
            }
            C::I32Or => {
                self.execute_branch_binop::<i32>(lhs, rhs, offset, <i32 as UntypedValueExt>::or)
            }
            C::I32Xor => {
                self.execute_branch_binop::<i32>(lhs, rhs, offset, <i32 as UntypedValueExt>::xor)
            }
            C::I32Nand => {
                self.execute_branch_binop::<i32>(lhs, rhs, offset, <i32 as UntypedValueExt>::nand)
            }
            C::I32Nor => {
                self.execute_branch_binop::<i32>(lhs, rhs, offset, <i32 as UntypedValueExt>::nor)
            }
            C::I32Xnor => {
                self.execute_branch_binop::<i32>(lhs, rhs, offset, <i32 as UntypedValueExt>::xnor)
            }
            ...
            C::I64And => {
                self.execute_branch_binop::<i64>(lhs, rhs, offset, <i64 as UntypedValueExt>::and)
            }
            C::I64Or => {
                self.execute_branch_binop::<i64>(lhs, rhs, offset, <i64 as UntypedValueExt>::or)
            }
            C::I64Xor => {
                self.execute_branch_binop::<i64>(lhs, rhs, offset, <i64 as UntypedValueExt>::xor)
            }
            C::I64Nand => {
                self.execute_branch_binop::<i64>(lhs, rhs, offset, <i64 as UntypedValueExt>::nand)
            }
            C::I64Nor => {
                self.execute_branch_binop::<i64>(lhs, rhs, offset, <i64 as UntypedValueExt>::nor)
            }
            C::I64Xnor => {
                self.execute_branch_binop::<i64>(lhs, rhs, offset, <i64 as UntypedValueExt>::xnor)
            }
