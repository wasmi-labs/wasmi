...
use crate::{
    core::{wasm, TrapCode},
    ir::{Const16, Local, ShiftAmount, Sign},
    Error,
};
...
impl Executor<'_> {
    impl_binary_executors! {
        ...
        (Instruction::I32And, execute_i32_and, wasm::i32_and),
        (Instruction::I32AndEqz, execute_i32_and_eqz, i32::i32_and_eqz),
        (Instruction::I32Or, execute_i32_or, wasm::i32_or),
        (Instruction::I32OrEqz, execute_i32_or_eqz, i32::i32_or_eqz),
        (Instruction::I32Xor, execute_i32_xor, wasm::i32_xor),
        (Instruction::I32XorEqz, execute_i32_xor_eqz, i32::i32_xor_eqz),
...
impl Executor<'_> {
    impl_binary_imm16! {
        ...
        (i32, Instruction::I32AndImm16, execute_i32_and_imm16, wasm::i32_and),
        (i32, Instruction::I32AndEqzImm16, execute_i32_and_eqz_imm16, i32::i32_and_eqz),
        (i32, Instruction::I32OrImm16, execute_i32_or_imm16, wasm::i32_or),
        (i32, Instruction::I32OrEqzImm16, execute_i32_or_eqz_imm16, i32::i32_or_eqz),
        (i32, Instruction::I32XorImm16, execute_i32_xor_imm16, wasm::i32_xor),
        (i32, Instruction::I32XorEqzImm16, execute_i32_xor_eqz_imm16, i32::i32_xor_eqz),
...
macro_rules! impl_shift_by {
    ( $( ($ty:ty, Instruction::$var_name:ident, $fn_name:ident, $op:expr) ),* $(,)? ) => {
        $(
            #[doc = concat!("Executes an [`Instruction::", stringify!($var_name), "`].")]
            pub fn $fn_name(&mut self, result: Local, lhs: Local, rhs: ShiftAmount<$ty>) {
...
macro_rules! impl_fallible_binary {
    ( $( (Instruction::$var_name:ident, $fn_name:ident, $op:expr) ),* $(,)? ) => {
        $(
            #[doc = concat!("Executes an [`Instruction::", stringify!($var_name), "`].")]
            pub fn $fn_name(&mut self, result: Local, lhs: Local, rhs: Local) -> Result<(), Error> {
...
macro_rules! impl_divrem_s_imm16_rhs {
    ( $( ($ty:ty, Instruction::$var_name:ident, $fn_name:ident, $op:expr) ),* $(,)? ) => {
        $(
            #[doc = concat!("Executes an [`Instruction::", stringify!($var_name), "`].")]
            pub fn $fn_name(&mut self, result: Local, lhs: Local, rhs: Const16<$ty>) -> Result<(), Error> {
...
macro_rules! impl_fallible_binary_imm16_lhs {
    ( $( ($ty:ty, Instruction::$var_name:ident, $fn_name:ident, $op:expr) ),* $(,)? ) => {
        $(
            #[doc = concat!("Executes an [`Instruction::", stringify!($var_name), "`].")]
            pub fn $fn_name(&mut self, result: Local, lhs: Const16<$ty>, rhs: Local) -> Result<(), Error> {
...
impl Executor<'_> {
    ...
    pub fn execute_f32_copysign_imm(&mut self, result: Local, lhs: Local, rhs: Sign<f32>) {
    ...
    pub fn execute_f64_copysign_imm(&mut self, result: Local, lhs: Local, rhs: Sign<f64>) {
