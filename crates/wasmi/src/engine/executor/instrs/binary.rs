...
impl Executor<'_> {
    impl_binary_executors! {
        ...
        (Instruction::I32BitAndEqz, execute_i32_bitand_eqz, i32::i32_bitand_eqz),
        (Instruction::I32BitOr, execute_i32_bitor, wasm::i32_bitor),
        (Instruction::I32BitOrEqz, execute_i32_bitor_eqz, i32::i32_bitor_eqz),
        (Instruction::I32BitXor, execute_i32_bitxor, wasm::i32_bitxor),
        (Instruction::I32BitXorEqz, execute_i32_bitxor_eqz, i32::i32_bitxor_eqz),
...
impl Executor<'_> {
    impl_binary_imm16! {
        ...
        (i32, Instruction::I32BitAndEqzImm16, execute_i32_bitand_eqz_imm16, i32::i32_bitand_eqz),
        (i32, Instruction::I32BitOrImm16, execute_i32_bitor_imm16, wasm::i32_bitor),
        (i32, Instruction::I32BitOrEqzImm16, execute_i32_bitor_eqz_imm16, i32::i32_bitor_eqz),
        (i32, Instruction::I32BitXorImm16, execute_i32_bitxor_imm16, wasm::i32_bitxor),
        (i32, Instruction::I32BitXorEqzImm16, execute_i32_bitxor_eqz_imm16, i32::i32_bitxor_eqz),
