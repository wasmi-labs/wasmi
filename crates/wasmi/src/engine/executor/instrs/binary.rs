...
impl Executor<'_> {
    impl_binary_executors! {
        ...
        (Instruction::I32And, execute_i32_and, i32::i32_and),
        (Instruction::I32Or, execute_i32_or, i32::i32_or),
        (Instruction::I32Xor, execute_i32_xor, i32::i32_xor),
        (Instruction::I32Nand, execute_i32_nand, i32::i32_nand),
        (Instruction::I32Nor, execute_i32_nor, i32::i32_nor),
        (Instruction::I32Xnor, execute_i32_xnor, i32::i32_xnor),
...
impl Executor<'_> {
    impl_binary_imm16! {
        ...
        (i32, Instruction::I32AndImm16, execute_i32_and_imm16, i32::i32_and),
        (i32, Instruction::I32OrImm16, execute_i32_or_imm16, i32::i32_or),
        (i32, Instruction::I32XorImm16, execute_i32_xor_imm16, i32::i32_xor),
        (i32, Instruction::I32NandImm16, execute_i32_nand_imm16, i32::i32_nand),
        (i32, Instruction::I32NorImm16, execute_i32_nor_imm16, i32::i32_nor),
        (i32, Instruction::I32XnorImm16, execute_i32_xnor_imm16, i32::i32_xnor),
