...
impl Executor<'_> {
    impl_unary_impls! {
        ...
        (Instruction::F32NegCanonicalizeNan, execute_f32_neg_canonicalize_nan, UntypedVal::f32_neg_canonicalize_nan),
        ...
        (Instruction::F32SqrtCanonicalizeNan, execute_f32_sqrt_canonicalize_nan, UntypedVal::f32_sqrt_canonicalize_nan),

        (Instruction::F64Abs, execute_f64_abs, UntypedVal::f64_abs),
        (Instruction::F64Neg, execute_f64_neg, UntypedVal::f64_neg),
        (Instruction::F64NegCanonicalizeNan, execute_f64_neg_canonicalize_nan, UntypedVal::f64_neg_canonicalize_nan),
        ...
        (Instruction::F64SqrtCanonicalizeNan, execute_f64_sqrt_canonicalize_nan, UntypedVal::f64_sqrt_canonicalize_nan),
    }
}
