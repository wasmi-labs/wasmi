    ...
    fn execute<T>(mut self, store: &mut Store<T>) -> Result<(), Error> {
        ...
        loop {
            match *self.ip.get() {
                ...
                Instr::F32NegCanonicalizeNan { .. } => todo!(),
