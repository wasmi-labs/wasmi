...
impl InstrEncoder {
    ...
    pub fn encode_branch_nez(
        ...
        let fused_instr = match *self.instrs.get(last_instr) {
            ...
            I::I32EqImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_eq_imm as _,
            )?,
            I::I32Ne(instr) => fuse(self, stack, last_instr, instr, label, I::branch_i32_ne as _)?,
            I::I32NeImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_ne_imm as _,
            )?,
            I::I32LtS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_lt_s as _,
            )?,
            I::I32LtSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_lt_s_imm as _,
            )?,
            I::I32LtU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_lt_u as _,
            )?,
            I::I32LtUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_lt_u_imm as _,
            )?,
            I::I32LeS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_le_s as _,
            )?,
            I::I32LeSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_le_s_imm as _,
            )?,
            I::I32LeU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_le_u as _,
            )?,
            I::I32LeUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_le_u_imm as _,
            )?,
            I::I32GtS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_gt_s as _,
            )?,
            I::I32GtSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_gt_s_imm as _,
            )?,
            I::I32GtU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_gt_u as _,
            )?,
            I::I32GtUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_gt_u_imm as _,
            )?,
            I::I32GeS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_ge_s as _,
            )?,
            I::I32GeSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_ge_s_imm as _,
            )?,
            I::I32GeU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i32_ge_u as _,
            )?,
            I::I32GeUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i32_ge_u_imm as _,
            )?,
            I::I64Eq(instr) => fuse(self, stack, last_instr, instr, label, I::branch_i64_eq as _)?,
            I::I64EqImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_eq_imm as _,
            )?,
            I::I64Ne(instr) => fuse(self, stack, last_instr, instr, label, I::branch_i64_ne as _)?,
            I::I64NeImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_ne_imm as _,
            )?,
            I::I64LtS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_lt_s as _,
            )?,
            I::I64LtSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_lt_s_imm as _,
            )?,
            I::I64LtU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_lt_u as _,
            )?,
            I::I64LtUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_lt_u_imm as _,
            )?,
            I::I64LeS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_le_s as _,
            )?,
            I::I64LeSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_le_s_imm as _,
            )?,
            I::I64LeU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_le_u as _,
            )?,
            I::I64LeUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_le_u_imm as _,
            )?,
            I::I64GtS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_gt_s as _,
            )?,
            I::I64GtSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_gt_s_imm as _,
            )?,
            I::I64GtU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_gt_u as _,
            )?,
            I::I64GtUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_gt_u_imm as _,
            )?,
            I::I64GeS(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_ge_s as _,
            )?,
            I::I64GeSImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_ge_s_imm as _,
            )?,
            I::I64GeU(instr) => fuse(
                self,
                stack,
                ...
                instr,
                label,
                I::branch_i64_ge_u as _,
            )?,
            I::I64GeUImm16(instr) => fuse_imm(
                self,
                stack,
                last_instr,
                instr,
                label,
                I::branch_i64_ge_u_imm as _,
            )?,
