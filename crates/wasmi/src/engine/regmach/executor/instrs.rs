...
impl<'ctx, 'engine> Executor<'ctx, 'engine> {
    ...
    #[inline(always)]
    fn execute_return_call_imported_0(&mut self, func: FuncIdx) -> Result<CallOutcome, TrapCode> {
    ...
    #[inline(always)]
    fn execute_return_call_imported(&mut self, func: FuncIdx) -> Result<CallOutcome, TrapCode> {
        let call_params = self.fetch_call_params(1);
        let func = self.cache.get_func(self.ctx, func);
...
impl<'engine, 'ctx> Executor<'engine, 'ctx> {
    ...
    fn execute_select(&mut self, result: Register, condition: Register, lhs: Register) {
    ...
    fn execute_select_rev(&mut self, result: Register, condition: Register, rhs: Register) {
    ...
    fn execute_select_imm32(&mut self, result: Register, lhs: AnyConst32) {
    ...
    fn execute_select_i64imm32(&mut self, result: Register, lhs: Const32<i64>) {
