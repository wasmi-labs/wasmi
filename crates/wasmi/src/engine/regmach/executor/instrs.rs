    ...
    fn execute(
        ...
        loop {
            match *self.ip.get() {
                ...
                Instr::BranchI32Nand(instr) => self.execute_branch_i32_nand(instr),
                Instr::BranchI32NandImm(instr) => self.execute_branch_i32_nand_imm(instr),
                Instr::BranchI32Nor(instr) => self.execute_branch_i32_nor(instr),
                Instr::BranchI32NorImm(instr) => self.execute_branch_i32_nor_imm(instr),
                Instr::BranchI32Xnor(instr) => self.execute_branch_i32_xnor(instr),
                Instr::BranchI32XnorImm(instr) => self.execute_branch_i32_xnor_imm(instr),
