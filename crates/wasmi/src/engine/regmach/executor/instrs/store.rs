...
use crate::{
    ...
    engine::{
        bytecode2::{Const16, Instruction, Register, StoreAtInstr, StoreInstr, StoreOffset16Instr},
...
macro_rules! impl_execute_istore {
    ( $(
        ...
        $(
            ...
            #[inline(always)]
            pub fn $fn_store(&mut self, instr: StoreInstr) -> Result<(), TrapCode> {
            ...
            #[inline(always)]
            pub fn $fn_store_at(&mut self, instr: StoreAtInstr<Register>) -> Result<(), TrapCode> {
