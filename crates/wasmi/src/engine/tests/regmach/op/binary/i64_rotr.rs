...
#[test]
fn reg_imm_rev() {
    test_binary_reg_imm64_rev(WASM_OP, i64::MAX, Instruction::i64_rotr_imm_rev)
}

#[test]
fn reg_imm16_rev() {
    test_binary_reg_imm16_rev::<i16>(WASM_OP, 100, Instruction::i64_rotr_imm16_rev)
}
...
fn consteval() {
    ...
    test_binary_consteval(
        ...
        lhs,
        rhs,
        [Instruction::return_i64imm32(lhs.rotate_right(rhs as u32))],
    )
}
