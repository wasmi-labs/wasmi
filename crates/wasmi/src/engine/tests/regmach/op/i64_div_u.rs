...
const WASM_OP: WasmOp = WasmOp::I64("div_u");
...
#[test]
fn reg_imm16() {
    test_binary_reg_imm16(WASM_OP, Instruction::i64_div_u_imm16)
}

#[test]
fn reg_imm16_rev() {
    test_binary_reg_imm16_rev(WASM_OP, Instruction::i64_div_u_imm16_rev)
}

#[test]
fn reg_imm() {
    test_binary_reg_imm64(WASM_OP, i64::MAX, Instruction::i64_div_u_imm)
}

#[test]
fn reg_imm_rev() {
    test_binary_reg_imm64_rev(WASM_OP, i64::MAX, Instruction::i64_div_u_imm)
}
