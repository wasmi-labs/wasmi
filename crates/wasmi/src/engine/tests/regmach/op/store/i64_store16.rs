...
#[test]
fn reg() {
    test_store(WASM_OP, 0, Instruction::i64_store16);
    test_store(WASM_OP, 42, Instruction::i64_store16);
    test_store(WASM_OP, u32::MAX, Instruction::i64_store16);
}

#[test]
fn imm() {
    fn make_instr_param(value: i64) -> Instruction {
        Instruction::const32(value as i16)
    }
...
#[test]
fn at() {
    test_store_at(WASM_OP, 0, 0, Instruction::i64_store16_at);
    test_store_at(WASM_OP, 5, 42, Instruction::i64_store16_at);
    test_store_at(WASM_OP, 0, u32::MAX, Instruction::i64_store16_at);
    test_store_at(WASM_OP, u32::MAX, 0, Instruction::i64_store16_at);
}
...
#[test]
fn imm_at() {
    fn make_instr(address: Const32<u32>, value: i32) -> Instruction {
        Instruction::i64_store16_imm_at(address, value as i16)
    }
