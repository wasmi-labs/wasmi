...
#[test]
fn reg() {
    test_store(WASM_OP, 0, Instruction::i32_store8);
    test_store(WASM_OP, 42, Instruction::i32_store8);
    test_store(WASM_OP, u32::MAX, Instruction::i32_store8);
}
...
#[test]
fn at() {
    test_store_at(WASM_OP, 0, 0, Instruction::i32_store8_at);
    test_store_at(WASM_OP, 5, 42, Instruction::i32_store8_at);
    test_store_at(WASM_OP, 0, u32::MAX, Instruction::i32_store8_at);
    test_store_at(WASM_OP, u32::MAX, 0, Instruction::i32_store8_at);
}
...
fn imm_at() {
    fn make_instr(address: Const32<u32>, value: i32) -> Instruction {
        Instruction::i32_store8_imm_at(address, value as i8)
    }
