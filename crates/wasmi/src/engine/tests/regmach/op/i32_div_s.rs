...
const WASM_OP: WasmOp = WasmOp::I32("div_s");
...
#[test]
fn reg_imm16() {
    test_binary_reg_imm16(WASM_OP, Instruction::i32_div_s_imm16)
}

#[test]
fn reg_imm16_rev() {
    test_binary_reg_imm16_rev(WASM_OP, Instruction::i32_div_s_imm16_rev)
}

#[test]
fn reg_imm() {
    test_binary_reg_imm32(WASM_OP, i32::MAX, Instruction::i32_div_s_imm)
}

#[test]
fn reg_imm_rev() {
    test_binary_reg_imm32_rev(WASM_OP, i32::MAX, Instruction::i32_div_s_imm)
}
