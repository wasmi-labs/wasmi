...
const WASM_OP: WasmOp = WasmOp::I32("eq");
...
#[test]
fn reg_imm16() {
    test_binary_reg_imm16(WASM_OP, Instruction::i32_eq_imm16)
}

#[test]
fn reg_imm16_rev() {
    test_binary_reg_imm16_rev(WASM_OP, swap_ops!(Instruction::i32_eq_imm16))
}
