...
const WASM_OP: WasmOp = WasmOp::I32("sub");
...
#[test]
fn reg_imm16_rev() {
    test_binary_reg_imm16_rev(WASM_OP, swap_ops!(Instruction::i32_sub_imm16_rev))
}

#[test]
fn reg_imm() {
    test_binary_reg_imm32(WASM_OP, Instruction::i32_sub_imm)
}

#[test]
fn reg_imm_rev() {
    test_binary_reg_imm32_rev(WASM_OP, Instruction::i32_sub_imm)
}
