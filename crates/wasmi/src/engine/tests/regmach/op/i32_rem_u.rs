...
const WASM_OP: WasmOp = WasmOp::I32("rem_u");
...
#[test]
fn reg_imm() {
    test_binary_reg_imm32(WASM_OP, Instruction::i32_rem_u_imm)
}

#[test]
fn reg_imm_rev() {
    test_binary_reg_imm32_rev(WASM_OP, Instruction::i32_rem_u_imm)
}
