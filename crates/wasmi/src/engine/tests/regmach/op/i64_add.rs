...
const WASM_OP: WasmOp = WasmOp::I64("add");
...
#[test]
fn reg_imm16_rev() {
    test_binary_reg_imm16_rev(WASM_OP, Instruction::i64_add_imm16)
}

#[test]
fn reg_imm() {
    test_binary_reg_imm64(WASM_OP, Instruction::i64_add_imm)
}

#[test]
fn reg_imm_rev() {
    test_binary_reg_imm64_rev(WASM_OP, Instruction::i64_add_imm)
}
