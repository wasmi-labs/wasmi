...
const WASM_OP: WasmOp = WasmOp::I64("rem_u");
...
#[test]
fn reg_imm() {
    test_binary_reg_imm64(WASM_OP, Instruction::i64_rem_u_imm)
}

#[test]
fn reg_imm_rev() {
    test_binary_reg_imm64_rev(WASM_OP, Instruction::i64_rem_u_imm)
}
