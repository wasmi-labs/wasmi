...
impl LogicalizeCmpInstr for Instruction {
    fn logicalize_cmp_instr(&self) -> Option<Self> {
        ...
        let negated = match *self {
            ...
            I::I64Eq { result, lhs, rhs } => I::i64_ne(result, lhs, rhs),
            I::I64Ne { result, lhs, rhs } => I::i64_eq(result, lhs, rhs),
            I::I64LeS { result, lhs, rhs } => I::i64_le_s(result, rhs, lhs),
            I::I64LeU { result, lhs, rhs } => I::i64_le_u(result, rhs, lhs),
            I::I64LtS { result, lhs, rhs } => I::i64_lt_s(result, rhs, lhs),
            I::I64LtU { result, lhs, rhs } => I::i64_lt_u(result, rhs, lhs),
