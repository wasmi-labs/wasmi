...
impl<'a> VisitOperator<'a> for FuncTranslator {
    ...
    fn visit_local_set(&mut self, local_index: u32) -> Self::Output {
        ...
        let local = Local::try_from(local_index)?;
