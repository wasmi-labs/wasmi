...
fn branched_block_1_imm_i32() {
    fn test_for_i32(value: i32) {
        testcase_branched_block_1_imm::<i32>(value)
            .expect_func_instrs([
                Instruction::copy_imm32(Reg::from_i16(0), AnyConst32::from(value)),
                Instruction::branch(BranchOffset::from(1)),
...
fn branched_block_1_imm_i64imm32() {
    fn test_for_i64imm32(value: i64) {
        ...
        testcase_branched_block_1_imm::<i64>(value)
            .expect_func_instrs([
                Instruction::copy_i64imm32(Reg::from_i16(0), const32),
                Instruction::branch(BranchOffset::from(1)),
                Instruction::return_reg(Reg::from_i16(0)),
            ])
            .run();
...
fn branched_block_1_imm_i64() {
    fn test_for_i64(value: i64) {
        testcase_branched_block_1_imm::<i64>(value)
            .expect_func(
                ExpectedFunc::new([
                    Instruction::copy(Reg::from_i16(0), Reg::from_i16(-1)),
                    Instruction::branch(BranchOffset::from(1)),
                    Instruction::return_reg(Reg::from_i16(0)),
                ])
                .consts([value]),
...
fn branched_block_1_imm_f64imm32() {
    fn test_for_f64imm32(value: f64) {
        ...
        testcase_branched_block_1_imm::<f64>(value)
            .expect_func_instrs([
                Instruction::copy_f64imm32(Reg::from_i16(0), const32),
                Instruction::branch(BranchOffset::from(1)),
                Instruction::return_reg(Reg::from_i16(0)),
            ])
            .run();
...
fn branched_block_2() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::copy2(RegSpan::new(Reg::from_i16(4)), 0, 1),
            Instruction::copy2(RegSpan::new(Reg::from_i16(2)), 4, 5),
            Instruction::branch(BranchOffset::from(1)),
...
fn branch_if_block_1() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            ...
            Instruction::copy(Reg::from_i16(2), Reg::from_i16(3)),
