...
fn consteval_return_1_imm() {
        ...
        DisplayWasm<T>: Display,
    {
        ...
        TranslationTest::from_wat(&wasm)
            .expect_func(
                ExpectedFunc::new([Instruction::return_reg(Reg::from_i16(-1))]).consts([expected]),
            )
            .run()
    }
...
fn return_if_results_0() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::return_nez(Reg::from_i16(0)),
            Instruction::Return,
        ])
        .run()
}
...
fn return_if_results_1() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::return_nez_reg(Reg::from_i16(1), Reg::from_i16(0)),
...
fn return_if_results_1_imm() {
        ...
        DisplayWasm<T>: Display,
    {
        ...
        TranslationTest::from_wat(&wasm)
            .expect_func(
                ExpectedFunc::new([
                    Instruction::return_nez_reg(Reg::from_i16(0), Reg::from_i16(-1)),
                    Instruction::return_reg(Reg::from_i16(-1)),
                ])
...
fn return_if_results_1_imm32() {
        ...
        DisplayWasm<T>: Display,
    {
        ...
        TranslationTest::from_wat(&wasm)
            .expect_func_instrs([
                Instruction::return_nez_imm32(Reg::from_i16(0), const32),
...
fn return_if_results_1_i64imm32() {
    fn test_for(returned_value: i64) {
        ...
        TranslationTest::from_wat(&wasm)
            .expect_func_instrs([
                return_nez_i64imm32_instr(Reg::from_i16(0), returned_value),
...
fn return_if_results_1_f64imm32() {
    fn test_for(returned_value: f64) {
        ...
        TranslationTest::from_wat(&wasm)
            .expect_func_instrs([
                return_nez_f64imm32_instr(Reg::from_i16(0), returned_value),
...
fn return_if_results_2() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::return_nez_reg2(Reg::from_i16(2), 0, 1),
...
fn return_if_results_2_rev() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::return_nez_reg2(Reg::from_i16(2), 1, 0),
...
fn return_if_results_2_imm() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func(
            ExpectedFunc::new([
                Instruction::return_nez_reg2(Reg::from_i16(0), -1, -2),
...
fn return_if_results_3_span() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::return_nez_span(Reg::from_i16(3), RegSpan::new(Reg::from_i16(0)).iter(3)),
...
fn return_if_results_3() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::return_nez_many(Reg::from_i16(2), 0, 1),
...
fn return_if_results_3_imm() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func(
            ExpectedFunc::new([
                Instruction::return_nez_many(Reg::from_i16(0), -1, -2),
...
fn return_if_results_4_span() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::return_nez_span(Reg::from_i16(4), RegSpan::new(Reg::from_i16(0)).iter(4)),
            Instruction::return_span(RegSpan::new(Reg::from_i16(0)).iter(4)),
        ])
        .run()
}
...
fn branch_if_results_0() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            ...
            Instruction::branch_i32_nez(Reg::from_i16(1), BranchOffset16::from(1)),
            Instruction::Return,
        ])
        .run()
}
...
fn branch_if_results_1() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            ...
            Instruction::branch_i32_eqz(Reg::from_i16(4), BranchOffset16::from(3)),
            Instruction::copy(2, 3),
...
fn branch_if_results_1_avoid_copy() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::i32_clz(Reg::from_i16(2), Reg::from_i16(0)),
            Instruction::i32_ctz(Reg::from_i16(3), Reg::from_i16(1)),
            Instruction::branch_i32_nez(Reg::from_i16(3), BranchOffset16::from(1)),
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::copy_span_non_overlapping(
                RegSpan::new(Reg::from_i16(5)),
                RegSpan::new(Reg::from_i16(0)),
                3,
            ),
            Instruction::branch_i32_eqz(Reg::from_i16(7), BranchOffset16::from(3)),
            Instruction::copy2(RegSpan::new(Reg::from_i16(3)), 5, 6),
            Instruction::branch(BranchOffset::from(2)),
            Instruction::copy2(RegSpan::new(Reg::from_i16(3)), 5, 6),
...
fn branch_if_results_2_avoid_copy() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::i32_clz(Reg::from_i16(3), Reg::from_i16(0)),
            Instruction::i32_ctz(Reg::from_i16(4), Reg::from_i16(1)),
            Instruction::branch_i32_nez(Reg::from_i16(2), BranchOffset16::from(1)),
            Instruction::i32_add(Reg::from_i16(3), Reg::from_i16(3), Reg::from_i16(4)),
...
fn branch_if_results_4_mixed_1() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func(
            ExpectedFunc::new([
                Instruction::branch_i32_eqz(Reg::from_i16(2), BranchOffset16::from(4)),
                Instruction::copy_many_non_overlapping(RegSpan::new(Reg::from_i16(3)), -1, 0),
                Instruction::register2(1, -2),
                Instruction::branch(BranchOffset::from(3)),
                Instruction::copy_many_non_overlapping(RegSpan::new(Reg::from_i16(3)), -1, 0),
                Instruction::register2(1, -2),
                Instruction::return_span(RegSpan::new(Reg::from_i16(3)).iter(4)),
            ])
            .consts([10_i32, 20]),
        )
        .run()
...
fn branch_if_results_4_mixed_2() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::branch_i32_eqz(Reg::from_i16(2), BranchOffset16::from(4)),
            Instruction::copy_many_non_overlapping(RegSpan::new(Reg::from_i16(3)), 0, 0),
