use super::*;
use crate::ir::{index::Global, BranchOffset, LocalSpan};
...
fn reg_params_1_diff() {
    ...
    TranslationTest::new(wasm)
        .expect_func_instrs([
            ...
            Instruction::branch_table_target(LocalSpan::new(Local::from(2)), BranchOffset::from(7)),
            Instruction::branch_table_target(LocalSpan::new(Local::from(2)), BranchOffset::from(6)),
            Instruction::branch_table_target(LocalSpan::new(Local::from(2)), BranchOffset::from(7)),
            Instruction::return_reg(input),
            Instruction::branch_table_target(LocalSpan::new(Local::from(3)), BranchOffset::from(1)),
