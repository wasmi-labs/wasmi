...
fn reg_reg() {
    test_binary_local_reg(WASM_OP, Instruction::f64_sub)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm() {
    test_binary_local_imm32(WASM_OP, 1.0_f64, Instruction::f64_sub)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm_lhs() {
    test_binary_local_imm32_lhs(WASM_OP, 1.0_f64, Instruction::f64_sub)
}
