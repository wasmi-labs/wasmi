...
#[cfg_attr(miri, ignore)]
fn reg_reg() {
    test_binary_local_reg(WASM_OP, Instruction::i64_and)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm16() {
    test_binary_local_imm16_rhs::<i64>(WASM_OP, 100, Instruction::i64_and_imm16)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm16_lhs() {
    test_binary_local_imm16_lhs::<i64>(WASM_OP, 100, swap_ops!(Instruction::i64_and_imm16))
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm() {
    test_binary_local_imm32(WASM_OP, i64::MAX, Instruction::i64_and)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm_lhs() {
    test_binary_local_imm32_lhs_commutative(WASM_OP, i64::MAX, Instruction::i64_and)
}
