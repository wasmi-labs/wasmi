...
fn reg_reg() {
    test_binary_local_reg(WASM_OP, Instruction::i64_shr_s)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm_lhs() {
    test_binary_local_imm32_lhs(WASM_OP, i64::MAX, Instruction::i64_shr_s)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm16_lhs() {
    test_binary_local_imm16_lhs::<i64>(WASM_OP, 100, Instruction::i64_shr_s_imm16)
}
...
fn reg_1_after_mod32() {
    let expected = [
        Instruction::i64_shr_s_by(Local::from(1), Local::from(0), shamt::<i64>(1)),
