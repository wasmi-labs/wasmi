...
fn same_reg() {
    ...
    let expected = [
        Instruction::i64_div_u(Reg::from(1), Reg::from(0), Reg::from(0)),
...
#[cfg_attr(miri, ignore)]
fn reg_imm16() {
    test_binary_reg_imm16::<NonZeroU64>(WASM_OP, nonzero_u64(100), Instruction::i64_div_u_imm16)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm16_lhs() {
    test_binary_reg_imm16_lhs::<u64>(WASM_OP, 100, Instruction::i64_div_u_imm16_lhs)
}
...
#[cfg_attr(miri, ignore)]
fn reg_imm_lhs() {
    test_binary_reg_imm32_lhs(WASM_OP, i64::MAX, Instruction::i64_div_u)
}
