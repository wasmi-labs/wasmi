...
fn same_reg() {
    ...
    let expected = [
        Instruction::i32_rem_s(Reg::from_i16(1), Reg::from_i16(0), Reg::from_i16(0)),
...
#[cfg_attr(miri, ignore)]
fn reg_imm16() {
    test_binary_reg_imm16::<NonZeroI32>(WASM_OP, nonzero_i32(100), Instruction::i32_rem_s_imm16)
}
