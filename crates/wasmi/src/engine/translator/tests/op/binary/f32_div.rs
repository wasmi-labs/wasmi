...
fn reg_reg() {
    test_binary_local_reg(WASM_OP, Instruction::f32_div)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm() {
    test_binary_local_imm32(WASM_OP, 1.0_f32, Instruction::f32_div)
}

#[test]
#[cfg_attr(miri, ignore)]
fn reg_imm_lhs() {
    test_binary_local_imm32_lhs(WASM_OP, 1.0_f32, Instruction::f32_div)
}
