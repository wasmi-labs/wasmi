...
fn no_params_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_indirect_0(RegSpan::new(Reg::from(1)), SignatureIdx::from(0)),
...
fn one_reg_param_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_indirect(RegSpan::new(Reg::from(2)), SignatureIdx::from(0)),
            Instruction::call_indirect_params(Reg::from(0), TableIdx::from(0)),
...
fn one_reg_param_imm16() {
    fn test_with(index: u32) {
        ...
        TranslationTest::from_wat(&wasm)
            .expect_func_instrs([
                Instruction::call_indirect_imm16(RegSpan::new(Reg::from(2)), SignatureIdx::from(0)),
                Instruction::call_indirect_params_imm16(u32imm16(index), TableIdx::from(0)),
                Instruction::register(1),
                Instruction::return_reg(Reg::from(2)),
            ])
    ...
    fn test_with(index: u32) {
        ...
        TranslationTest::from_wat(&wasm)
            .expect_func(
                ExpectedFunc::new([
                    Instruction::call_indirect(RegSpan::new(Reg::from(2)), SignatureIdx::from(0)),
                    Instruction::call_indirect_params(Reg::from(-1), TableIdx::from(0)),
                    Instruction::register(1),
                    Instruction::return_reg(Reg::from(2)),
                ])
                .consts([index]),
...
fn one_imm_param_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func(
            ExpectedFunc::new([
                Instruction::call_indirect(RegSpan::new(Reg::from(1)), SignatureIdx::from(0)),
                Instruction::call_indirect_params(Reg::from(0), TableIdx::from(0)),
                Instruction::register(-1),
...
fn params7_reg_index_local() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_indirect(RegSpan::new(Reg::from(8)), SignatureIdx::from(0)),
            Instruction::call_indirect_params(Reg::from(0), TableIdx::from(0)),
...
fn params8_reg_index_local() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_indirect(RegSpan::new(Reg::from(9)), SignatureIdx::from(0)),
            Instruction::call_indirect_params(Reg::from(0), TableIdx::from(0)),
            Instruction::register_list(1, 2, 3),
            Instruction::register_list(4, 5, 6),
...
fn params9_reg_index_local() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_indirect(RegSpan::new(Reg::from(10)), SignatureIdx::from(0)),
            Instruction::call_indirect_params(Reg::from(0), TableIdx::from(0)),
            Instruction::register_list(1, 2, 3),
            Instruction::register_list(4, 5, 6),
...
fn regression_issue_768() {
    ...
    TranslationTest::from_wat(wasm)
        ...
        .expect_func(
            ExpectedFunc::new([
                Instruction::global_get(Reg::from(0), GlobalIdx::from(0)),
                Instruction::global_get(Reg::from(1), GlobalIdx::from(1)),
                Instruction::call_indirect(results, SignatureIdx::from(0)),
                Instruction::call_indirect_params(Reg::from(1), TableIdx::from(0)),
                Instruction::register2(0, -1),
                Instruction::return_reg(result),
