...
fn no_params() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported_0(RegSpan::new(Reg::from(0)), FuncIdx::from(0)),
            Instruction::Return,
        ])
        .run();
}
...
fn one_param_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from(1)), FuncIdx::from(0)),
...
fn two_params_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from(2)), FuncIdx::from(0)),
...
fn three_params_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from(3)), FuncIdx::from(0)),
...
fn params7_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from(7)), FuncIdx::from(0)),
...
fn params8_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from(8)), FuncIdx::from(0)),
            Instruction::register_list(0, 1, 2),
            Instruction::register_list(3, 4, 5),
...
fn params9_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from(9)), FuncIdx::from(0)),
            Instruction::register_list(0, 1, 2),
            Instruction::register_list(3, 4, 5),
