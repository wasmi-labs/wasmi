use super::*;
use crate::engine::{bytecode::FuncIdx, RegSpan};
...
fn no_params() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported_0(RegSpan::new(Reg::from_i16(0)), FuncIdx::from(0)),
            Instruction::Return,
        ])
        .run();
}
...
fn one_param_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from_i16(1)), FuncIdx::from(0)),
...
fn two_params_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from_i16(2)), FuncIdx::from(0)),
...
fn three_params_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from_i16(3)), FuncIdx::from(0)),
...
fn params7_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from_i16(7)), FuncIdx::from(0)),
            Instruction::register_list(0, 1, 2),
            Instruction::register_list(3, 4, 5),
            Instruction::register(6),
            Instruction::return_span(RegSpan::new(Reg::from_i16(7)).iter(7)),
        ])
        .run();
}
    ...
    TranslationTest::from_wat(wasm)
        .expect_func(
            ExpectedFunc::new([
                ...
                Instruction::return_span(RegSpan::new(Reg::from_i16(0)).iter(7)),
            ])
...
fn params8_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from_i16(8)), FuncIdx::from(0)),
            Instruction::register_list(0, 1, 2),
            Instruction::register_list(3, 4, 5),
            Instruction::register2(6, 7),
            Instruction::return_span(RegSpan::new(Reg::from_i16(8)).iter(8)),
        ])
        .run();
}
    ...
    TranslationTest::from_wat(wasm)
        .expect_func(
            ExpectedFunc::new([
                ...
                Instruction::return_span(RegSpan::new(Reg::from_i16(0)).iter(8)),
            ])
...
fn params9_reg() {
    ...
    TranslationTest::from_wat(wasm)
        .expect_func_instrs([
            Instruction::call_imported(RegSpan::new(Reg::from_i16(9)), FuncIdx::from(0)),
            Instruction::register_list(0, 1, 2),
            Instruction::register_list(3, 4, 5),
            Instruction::register3(6, 7, 8),
            Instruction::return_span(RegSpan::new(Reg::from_i16(9)).iter(9)),
        ])
        .run();
}
    ...
    TranslationTest::from_wat(wasm)
        .expect_func(
            ExpectedFunc::new([
                ...
                Instruction::return_span(RegSpan::new(Reg::from_i16(0)).iter(9)),
            ])
