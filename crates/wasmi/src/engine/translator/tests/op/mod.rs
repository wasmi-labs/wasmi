...
use super::{
    ...
    test_binary_local_imm16_lhs,
    test_binary_local_imm16_rhs,
    test_binary_local_imm32,
    test_binary_local_imm32_lhs,
    test_binary_local_imm32_lhs_commutative,
    test_binary_local_imm_lhs_with,
    test_binary_local_imm_with,
    test_binary_local_reg,
    test_binary_same_reg,
    testcase_binary_consteval,
    testcase_binary_imm_reg,
    testcase_binary_local_imm,
    wasm_type,
    AnyConst32,
    Const16,
    Const32,
