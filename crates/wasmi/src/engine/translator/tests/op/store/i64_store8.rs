...
fn imm() {
    ...
    for value in values {
        test_store_wrap_imm::<i64, i8, i8>(WASM_OP, Instruction::i64_store8_imm, value);
    }
}
...
fn at_imm() {
    ...
    for value in values {
        test_store_wrap_at_imm::<i64, i8, i8>(WASM_OP, Instruction::i64_store8_at_imm, value);
    }
}
...
fn at_imm_fallback() {
    ...
    .into_iter()
    .for_each(|value| {
        test_store_wrap_at_imm16_fallback::<i64, i8>(WASM_OP, Instruction::i64_store8_imm, value);
    });
}
