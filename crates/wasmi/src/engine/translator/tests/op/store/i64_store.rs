...
fn offset16_imm() {
    ...
    .into_iter()
    .for_each(|value| {
        test_store_offset16_imm::<i64>(WASM_OP, value, Instruction::store64_offset16);
    })
}
...
fn offset16_imm16() {
    ...
    .into_iter()
    .for_each(|value| {
        test_store_offset16_imm16::<i16>(WASM_OP, Instruction::i64_store_offset16_imm16, value);
    })
}
...
fn at_imm_fallback() {
    ...
    .into_iter()
    .for_each(|value| {
        test_store_at_imm_fallback::<i64>(WASM_OP, Instruction::i64_store_imm16, value);
    })
}
