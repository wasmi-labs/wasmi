...
impl HostVisitor for &'_ mut Instruction {
    fn host_visitor<V: VisitRegs>(self, visitor: &mut V) {
        ...
        match self {
            | Instr::Trap { .. } | Instr::ConsumeFuel { .. } | Instr::Return => {}
            ...
            | Instr::ReturnNezReg { condition, value } => {
                host_visitor!(visitor => condition, value)
            }
            | Instr::ReturnNezReg2 { condition, values } => {
                host_visitor!(visitor => condition, values)
            }
            ...
            | Instr::BranchCmpFallback { lhs, rhs, params } => {
                host_visitor!(visitor => lhs, rhs, params)
            }
            ...
            | Instr::CopySpanNonOverlapping {
                results, values, ..
            } => host_visitor!(visitor => Res(results), values),
            ...
            | Instr::Select { result, lhs } | Instr::SelectImm32Rhs { result, lhs } => {
                host_visitor!(visitor => Res(result), lhs)
            }
            | Instr::SelectImm32Lhs { result, .. } | Instr::SelectImm32 { result, .. } => {
                host_visitor!(visitor => Res(result))
            }
            ...
            | Instr::GlobalSetI32Imm16 { .. } | Instr::GlobalSetI64Imm16 { .. } => {}
            ...
            | Instr::I64Load32uOffset16 { result, ptr, .. } => {
                host_visitor!(visitor => Res(result), ptr)
            }
            | Instr::I32Store { ptr, .. }
            | Instr::I32Store8 { ptr, .. }
            ...
            | Instr::I32Rotr { result, lhs, rhs } => {
                host_visitor!(visitor => Res(result), lhs, rhs)
            }
            ...
            | Instr::I32RotrImm16Rev { result, rhs, .. } => {
                host_visitor!(visitor => Res(result), rhs)
            }
            ...
            | Instr::I64RotrImm16Rev { result, rhs, .. } => {
                host_visitor!(visitor => Res(result), rhs)
            }
            ...
            | Instr::F32CopysignImm { result, lhs, .. } => {
                host_visitor!(visitor => Res(result), lhs)
            }
            ...
            | Instr::F64CopysignImm { result, lhs, .. } => {
                host_visitor!(visitor => Res(result), lhs)
            }
            ...
            | Instr::F64ConvertI64U { result, input } => {
                host_visitor!(visitor => Res(result), input)
            }
            ...
            | Instr::TableGrow {
                ...
                delta,
                value,
            } => host_visitor!(visitor => Res(result), delta, value),
            ...
            | Instr::BranchTableTargetNonOverlapping { results, .. } => {
                host_visitor!(visitor => results)
            }
