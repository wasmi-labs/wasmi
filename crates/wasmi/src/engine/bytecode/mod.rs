...
pub enum Instruction {
    ...
    GlobalSet(GlobalIdx),
    I32Load(ConstRef),
    I32LoadOpt(AddressOffset),
    I64Load(ConstRef),
    I64LoadOpt(AddressOffset),
    F32Load(ConstRef),
    F32LoadOpt(AddressOffset),
    F64Load(ConstRef),
    F64LoadOpt(AddressOffset),
    I32Load8S(ConstRef),
    I32Load8SOpt(AddressOffset),
    I32Load8U(ConstRef),
    I32Load8UOpt(AddressOffset),
    I32Load16S(ConstRef),
    I32Load16SOpt(AddressOffset),
    I32Load16U(ConstRef),
    I32Load16UOpt(AddressOffset),
    I64Load8S(ConstRef),
    I64Load8SOpt(AddressOffset),
    I64Load8U(ConstRef),
    I64Load8UOpt(AddressOffset),
    I64Load16S(ConstRef),
    I64Load16SOpt(AddressOffset),
    I64Load16U(ConstRef),
    I64Load16UOpt(AddressOffset),
    I64Load32S(ConstRef),
    I64Load32SOpt(AddressOffset),
    I64Load32U(ConstRef),
    I64Load32UOpt(AddressOffset),
    I32Store(ConstRef),
    I32StoreOpt(AddressOffset),
    I64Store(ConstRef),
    I64StoreOpt(AddressOffset),
    F32Store(ConstRef),
    F32StoreOpt(AddressOffset),
    F64Store(ConstRef),
    F64StoreOpt(AddressOffset),
    I32Store8(ConstRef),
    I32Store8Opt(AddressOffset),
    I32Store16(ConstRef),
    I32Store16Opt(AddressOffset),
    I64Store8(ConstRef),
    I64Store8Opt(AddressOffset),
    I64Store16(ConstRef),
    I64Store16Opt(AddressOffset),
    I64Store32(ConstRef),
    I64Store32Opt(AddressOffset),
    MemorySize,
    MemoryGrow,
    MemoryFill,
    MemoryCopy,
