...
impl Instruction {
    ...
    constructor_for! {
        ...
        fn i32_shr_s(binary) -> Self::I32ShrU;
        fn i32_shr_s_imm(binary_imm16) -> Self::I32ShrUImm;
        fn i32_shr_s_imm_rev(binary_imm) -> Self::I32ShrUImmRev;
        fn i32_shr_s_imm16_rev(binary_imm16_rev) -> Self::I32ShrUImm16Rev;
