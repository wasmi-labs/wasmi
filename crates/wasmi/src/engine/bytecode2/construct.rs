...
impl Instruction {
    ...
    constructor_for! {
        ...
        fn i64_add_imm16(binary_imm16) -> Self::I64AddImm16;

        fn i32_sub(binary) -> Self::I32Sub;
        fn i32_sub_imm16(binary_imm16) -> Self::I32SubImm16;
        fn i32_sub_imm16_rev(binary_imm16_rev) -> Self::I32SubImm16Rev;

        fn i64_sub(binary) -> Self::I64Sub;
        fn i64_sub_imm16(binary_imm16) -> Self::I64SubImm16;
        fn i64_sub_imm16_rev(binary_imm16_rev) -> Self::I64SubImm16Rev;
