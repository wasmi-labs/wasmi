...
use crate::{
    engine::{CompiledFunc, FuncBuilder, FuncTranslatorAllocations, FuncTranslatorAllocations2},
    errors::ModuleError,
};
...
pub fn translate<'parser>(
    ...
    (allocations, allocations2): (FuncTranslatorAllocations, FuncTranslatorAllocations2),
