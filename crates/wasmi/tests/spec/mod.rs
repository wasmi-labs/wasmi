...
define_spec_tests! {
    ...
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_binary("binary");
    fn wasm_block("block");
    fn wasm_br("br");
    fn wasm_br_if("br_if");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_br_table("br_table");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_bulk("bulk");
    fn wasm_call("call");
    #[should_panic(expected = "multiple tables")] fn wasm_call_indirect("call_indirect");
    fn wasm_comments("comments");
    fn wasm_const("const");
    fn wasm_conversions("conversions");
    fn wasm_custom("custom");
    fn wasm_data("data");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_elem("elem");
    fn wasm_endianness("endianness");
    #[should_panic(expected = "multiple tables")] fn wasm_exports("exports");
    fn wasm_f32("f32");
    ...
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_global("global");
    fn wasm_i32("i32");
    fn wasm_i64("i64");
    fn wasm_if("if");
    #[should_panic(expected = "multiple tables")] fn wasm_imports("imports");
    ...
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_linking("linking");
    fn wasm_load("load");
    ...
    fn wasm_names("names");
    fn wasm_nop("nop");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_ref_func("ref_func");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_ref_is_null("ref_is_null");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_ref_null("ref_null");
    fn wasm_return("return");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_select("select");
    ...
    #[should_panic(expected = "multiple tables")] fn wasm_table("table");
    #[should_panic(expected = "multiple tables")] fn wasm_table_copy("table_copy");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_table_fill("table_fill");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_table_get("table_get");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_table_grow("table_grow");
    #[should_panic(expected = "multiple tables")] fn wasm_table_init("table_init");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_table_set("table_set");
    #[should_panic(expected = "multiple tables")] fn wasm_table_size("table_size");
    fn wasm_token("token");
    fn wasm_traps("traps");
    fn wasm_type("type");
    fn wasm_unreachable("unreachable");
    fn wasm_unreached_invalid("unreached-invalid");
    #[should_panic(expected = "reference types support is not enabled")] fn wasm_unreached_valid("unreached-valid");
