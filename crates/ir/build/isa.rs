...
fn add_return_ops(isa: &mut Isa) {
    let ops = [
        ...
        Op::from(ReturnOp::new(Ty::F32, OperandKind::Slot)),
        Op::from(ReturnOp::new(Ty::F32, OperandKind::Immediate)),
        Op::from(ReturnOp::new(Ty::F64, OperandKind::Slot)),
        Op::from(ReturnOp::new(Ty::F64, OperandKind::Immediate)),
